...
# *********************** footway_S_modular loc no and wayleave yes *********************************************

footway_s_modular_way = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Footway') & (df['loc'] == False)
                         & (df['wayleave'] == True) & (df['material'] == 'Modular' ) & (df['type'] == 'Access') ]

footway_s_modular_2x96_way = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Footway') & (df['loc'] == False)
                         & (df['wayleave'] == True) & (df['material'] == 'Modular') & (df['type'] == 'Access')
                         & (df['96mm'] == '2x96')]

num_of_rows_fw_s_modular_way = footway_s_modular_way['length'].sum()

num_of_rows_fw_s_modular_2x96_way = footway_s_modular_2x96_way['length'].sum()

num_of_rows_fw_s_modular_total_way = num_of_rows_fw_s_modular_way + num_of_rows_fw_s_modular_2x96_way
...
ws = wb[sheets[n]]
ws_tables = []
ws["J54"] = num_of_rows_fw_s_modular_total_way
wb.save(filename)


# *********************** footway_S_concrete loc no and wayleave yes  *********************************************

footway_s_concrete_way = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Footway') & (df['loc'] == False)
                         & (df['wayleave'] == True) & (df['material'] == 'Concrete') & (df['type'] == 'Access') ]

footway_s_concrete_2x96_way = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Footway') & (df['loc'] == False)
                         & (df['wayleave'] == True) & (df['material'] == 'Concrete') & (df['type'] == 'Access')
                         & (df['96mm'] == '2x96')]

num_of_rows_fw_s_concrete_way = footway_s_concrete_way['length'].sum()

num_of_rows_fw_s_concrete_2x96_way = footway_s_concrete_2x96_way['length'].sum()

num_of_rows_fw_s_concrete_total_way = num_of_rows_fw_s_concrete_way + num_of_rows_fw_s_concrete_2x96_way
...
ws = wb[sheets[n]]
ws_tables = []
ws["K54"] = num_of_rows_fw_s_concrete_total_way
wb.save(filename)

# *********************** footway_S_unmade and grassverge loc no and wayleave yes  *********************************************

footway_s_grassverge_way = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Footway') & (df['loc'] == False)
                         & (df['wayleave'] == True) & (df['material'] == 'Grass Verge') & (df['type'] == 'Access')]

footway_s_unmade_way = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Footway') & (df['loc'] == False)
                         & (df['wayleave'] == True) & (df['material'] == 'Unmade') & (df['type'] == 'Access')]

footway_s_grassverge_2x96_way = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Footway') & (df['loc'] == False)
                         & (df['wayleave'] == True) & (df['material'] == 'Grass Verge') & (df['type'] == 'Access') & (df['96mm'] == '2x96')]

footway_s_unmade_2x96_way = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Footway') & (df['loc'] == False)
                         & (df['wayleave'] == True) & (df['material'] == 'Unmade') & (df['type'] == 'Access') & (df['96mm'] == '2x96')]


num_of_rows_fw_s_grassverge_way = footway_s_grassverge_way['length'].sum()

num_of_rows_fw_s_unmade_way = footway_s_unmade_way['length'].sum()

num_of_rows_fw_s_grassverge_2x96_way = footway_s_grassverge_2x96_way['length'].sum()

num_of_rows_fw_s_unmade_2x96_way = footway_s_unmade_2x96_way['length'].sum()

num_of_rows_fw_s_unmade_grassverge_total_way = num_of_rows_fw_s_grassverge_way + num_of_rows_fw_s_unmade_way + num_of_rows_fw_s_grassverge_2x96_way + num_of_rows_fw_s_unmade_2x96_way
...
ws = wb[sheets[n]]
ws_tables = []
ws["L54"] = num_of_rows_fw_s_unmade_grassverge_total_way
wb.save(filename)

# *********************** footway_S_tarmac loc no and wayleave yes  ************************************************

footway_s_tarmac_way = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Footway') & (df['loc'] == False)
                         & (df['wayleave'] == True) & (df['material'] == 'Tarmac') & (df['type'] == 'Access') ]

footway_s_tarmac_2x96_way = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Footway') & (df['loc'] == False)
                         & (df['wayleave'] == True) & (df['material'] == 'Tarmac') & (df['type'] == 'Access')
                         &  (df['96mm'] == '2x96') ]

num_of_rows_fw_s_tarmac_way = footway_s_tarmac_way['length'].sum()

num_of_rows_fw_s_tarmac_2x96_way = footway_s_tarmac_2x96_way['length'].sum()

num_of_rows_fw_s_tarmac_total_way = num_of_rows_fw_s_tarmac_way + num_of_rows_fw_s_tarmac_2x96_way
...
ws = wb[sheets[n]]
ws_tables = []
ws["M54"] = num_of_rows_fw_s_tarmac_total_way
wb.save(filename)

# *********************** footway_T_modular loc no and wayleave yes  *********************************************

footway_t_modular_way = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Footway') & (df['loc'] == False)
                         & (df['wayleave'] == True) & (df['material'] == 'Modular' ) & (df['type'] == 'Trunk') ]

footway_t_modular_2x96_way = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Footway') & (df['loc'] == False)
                         & (df['wayleave'] == True) & (df['material'] == 'Modular') & (df['type'] == 'Trunk')
                         & (df['96mm'] == '2x96')]

num_of_rows_fw_t_modular_way = footway_t_modular_way['length'].sum()

num_of_rows_fw_t_modular_2x96_way = footway_t_modular_2x96_way['length'].sum()

num_of_rows_fw_t_modular_total_way = num_of_rows_fw_t_modular_way + num_of_rows_fw_t_modular_2x96_way
...
ws = wb[sheets[n]]
ws_tables = []
ws["J55"] = num_of_rows_fw_t_modular_total_way
wb.save(filename)


# *********************** footway_t_concrete loc no and wayleave yes  *********************************************

footway_t_concrete_way = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Footway') & (df['loc'] == False)
                         & (df['wayleave'] == True) & (df['material'] == 'Concrete') & (df['type'] == 'Trunk') ]

footway_t_concrete_2x96_way = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Footway') & (df['loc'] == False)
                         & (df['wayleave'] == True) & (df['material'] == 'Concrete') & (df['type'] == 'Trunk')
                         & (df['96mm'] == '2x96')]

num_of_rows_fw_t_concrete_way = footway_t_concrete_way['length'].sum()

num_of_rows_fw_t_concrete_2x96_way = footway_t_concrete_2x96_way['length'].sum()

num_of_rows_fw_t_concrete_total_way = num_of_rows_fw_t_concrete_way + num_of_rows_fw_t_concrete_2x96_way
...
ws = wb[sheets[n]]
ws_tables = []
ws["K55"] = num_of_rows_fw_t_concrete_total_way
wb.save(filename)

# *********************** footway_T_unmade and grassverge loc no and wayleave yes  *********************************************

footway_t_grassverge_way = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Footway') & (df['loc'] == False)
                         & (df['wayleave'] == True) & (df['material'] == 'Grass Verge') & (df['type'] == 'Trunk')]

footway_t_unmade_way = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Footway') & (df['loc'] == False)
                         & (df['wayleave'] == True) & (df['material'] == 'Unmade') & (df['type'] == 'Trunk')]

footway_t_grassverge_2x96_way = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Footway') & (df['loc'] == False)
                         & (df['wayleave'] == True) & (df['material'] == 'Grass Verge') & (df['type'] == 'Trunk') & (df['96mm'] == '2x96')]

footway_t_unmade_2x96_way = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Footway') & (df['loc'] == False)
                         & (df['wayleave'] == True) & (df['material'] == 'Unmade') & (df['type'] == 'Trunk') & (df['96mm'] == '2x96')]


num_of_rows_fw_t_grassverge_way = footway_t_grassverge_way['length'].sum()

num_of_rows_fw_t_unmade_way = footway_t_unmade_way['length'].sum()

num_of_rows_fw_t_grassverge_2x96_way = footway_t_grassverge_2x96_way['length'].sum()

num_of_rows_fw_t_unmade_2x96_way = footway_t_unmade_2x96_way['length'].sum()

num_of_rows_fw_t_unmade_grassverge_total_way = num_of_rows_fw_t_grassverge_way + num_of_rows_fw_t_unmade_way + num_of_rows_fw_t_grassverge_2x96_way + num_of_rows_fw_t_unmade_2x96_way
...
ws = wb[sheets[n]]
ws_tables = []
ws["L55"] = num_of_rows_fw_t_unmade_grassverge_total_way
wb.save(filename)

# *********************** footway_T_tarmac loc no and wayleave yes  ************************************************

footway_t_tarmac_way = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Footway') & (df['loc'] == False)
                         & (df['wayleave'] == True) & (df['material'] == 'Tarmac') & (df['type'] == 'Trunk') ]

footway_t_tarmac_2x96_way = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Footway') & (df['loc'] == False)
                         & (df['wayleave'] == True) & (df['material'] == 'Tarmac') & (df['type'] == 'Trunk')
                         &  (df['96mm'] == '2x96') ]

num_of_rows_fw_t_tarmac_way = footway_t_tarmac_way['length'].sum()

num_of_rows_fw_t_tarmac_2x96_way = footway_t_tarmac_2x96_way['length'].sum()

num_of_rows_fw_t_tarmac_total_way = num_of_rows_fw_t_tarmac_way + num_of_rows_fw_t_tarmac_2x96_way
...
ws = wb[sheets[n]]
ws_tables = []
ws["M55"] = num_of_rows_fw_t_tarmac_total_way
wb.save(filename)

# *********************** road crossing_S+T_modular loc no and wayleave yes  *********************************************

roadcrossing_s_t_modular_way = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Road Crossing') & (df['loc'] == False)
                         & (df['wayleave'] == True) & (df['material'] == 'Modular' ) & (df['type'] == 'Access & Trunk') ]

roadcrossing_s_t_modular_2x96_way = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Road Crossing') & (df['loc'] == False)
                         & (df['wayleave'] == True) & (df['material'] == 'Modular') & (df['type'] == 'Access & Trunk')
                         & (df['96mm'] == '2x96')]

num_of_rows_rc_s_t_modular_way = roadcrossing_s_t_modular_way['length'].sum()

num_of_rows_rc_s_t_modular_2x96_way = roadcrossing_s_t_modular_2x96_way['length'].sum()

num_of_rows_rc_s_t_modular_total_way = num_of_rows_rc_s_t_modular_way + num_of_rows_rc_s_t_modular_2x96_way
...
ws = wb[sheets[n]]
ws_tables = []
ws["J60"] = num_of_rows_rc_s_t_modular_total_way
wb.save(filename)

# *********************** road crossing_S+T_concrete loc no and wayleave yes  *********************************************

roadcrossing_s_t_concrete_way = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Road Crossing') & (df['loc'] == False)
                         & (df['wayleave'] == True) & (df['material'] == 'Concrete') & (df['type'] == 'Access & Trunk') ]

roadcrossing_s_t_concrete_2x96_way = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Road Crossing') & (df['loc'] == False)
                         & (df['wayleave'] == True) & (df['material'] == 'Concrete') & (df['type'] == 'Access & Trunk')
                         & (df['96mm'] == '2x96')]

num_of_rows_rc_s_t_concrete_way = roadcrossing_s_t_concrete_way['length'].sum()

num_of_rows_rc_s_t_concrete_2x96_way = roadcrossing_s_t_concrete_2x96_way['length'].sum()

num_of_rows_rc_s_t_concrete_total_way = num_of_rows_rc_s_t_concrete_way + num_of_rows_rc_s_t_concrete_2x96_way
...
ws = wb[sheets[n]]
ws_tables = []
ws["K60"] = num_of_rows_rc_s_t_concrete_total_way
wb.save(filename)

# *********************** road crossing_S+T_unmade and grassverge loc no and wayleave yes  *********************************************

roadcrossing_s_t_grassverge_way = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Road Crossing') & (df['loc'] == False)
                         & (df['wayleave'] == True) & (df['material'] == 'Grass Verge') & (df['type'] == 'Access & Trunk')]

roadcrossing_s_t_unmade_way = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Road Crossing') & (df['loc'] == False)
                         & (df['wayleave'] == True) & (df['material'] == 'Unmade') & (df['type'] == 'Access & Trunk')]

roadcrossing_s_t_grassverge_2x96_way = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Road Crossing') & (df['loc'] == False)
                         & (df['wayleave'] == True) & (df['material'] == 'Grass Verge') & (df['type'] == 'Access & Trunk') & (df['96mm'] == '2x96')]

roadcrossing_s_t_unmade_2x96_way = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Road Crossing') & (df['loc'] == False)
                         & (df['wayleave'] == True) & (df['material'] == 'Unmade') & (df['type'] == 'Access & Trunk') & (df['96mm'] == '2x96')]


num_of_rows_rc_s_t_grassverge_way = roadcrossing_s_t_grassverge_way['length'].sum()

num_of_rows_rc_s_t_unmade_way = roadcrossing_s_t_unmade_way['length'].sum()

num_of_rows_rc_s_t_grassverge_2x96_way = roadcrossing_s_t_grassverge_2x96_way['length'].sum()

num_of_rows_rc_s_t_unmade_2x96_way = roadcrossing_s_t_unmade_2x96_way['length'].sum()

num_of_rows_rc_s_t_unmade_grassverge_total_way = num_of_rows_rc_s_t_grassverge_way + num_of_rows_rc_s_t_unmade_way + num_of_rows_rc_s_t_grassverge_2x96_way + num_of_rows_rc_s_t_unmade_2x96_way
...
ws = wb[sheets[n]]
ws_tables = []
ws["L60"] = num_of_rows_rc_s_t_unmade_grassverge_total_way
wb.save(filename)

# *********************** road crossing_S+T_tarmac loc no and wayleave yes  *********************************************

roadcrossing_s_t_tarmac_way = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Road Crossing') & (df['loc'] == False)
                         & (df['wayleave'] == True) & (df['material'] == 'Tarmac' ) & (df['type'] == 'Access & Trunk') ]

roadcrossing_s_t_tarmac_2x96_way = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Road Crossing') & (df['loc'] == False)
                         & (df['wayleave'] == True) & (df['material'] == 'Tarmac') & (df['type'] == 'Access & Trunk')
                         & (df['96mm'] == '2x96')]

num_of_rows_rc_s_t_tarmac_way = roadcrossing_s_t_tarmac_way['length'].sum()

num_of_rows_rc_s_t_tarmac_2x96_way = roadcrossing_s_t_tarmac_2x96_way['length'].sum()

num_of_rows_rc_s_t_tarmac_total_way = num_of_rows_rc_s_t_tarmac_way + num_of_rows_rc_s_t_tarmac_2x96_way
...
ws = wb[sheets[n]]
ws_tables = []
ws["M60"] = num_of_rows_rc_s_t_tarmac_total_way
wb.save(filename)

# *********************** road crossing_D+T_modular loc no and wayleave yes  *********************************************

roadcrossing_d_t_modular_way = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Road Crossing') & (df['loc'] == False)
                         & (df['wayleave'] == True) & (df['material'] == 'Modular' ) & (df['type'] == 'Distribution & Trunk') ]

roadcrossing_d_t_modular_2x96_way = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Road Crossing') & (df['loc'] == False)
                         & (df['wayleave'] == True) & (df['material'] == 'Modular') & (df['type'] == 'Distribution & Trunk')
                         & (df['96mm'] == '2x96')]

num_of_rows_rc_d_t_modular_way = roadcrossing_d_t_modular_way['length'].sum()

num_of_rows_rc_d_t_modular_2x96_way = roadcrossing_d_t_modular_2x96_way['length'].sum()

num_of_rows_rc_d_t_modular_total_way = num_of_rows_rc_d_t_modular_way + num_of_rows_rc_d_t_modular_2x96_way
...
ws = wb[sheets[n]]
ws_tables = []
ws["J61"] = num_of_rows_rc_d_t_modular_total_way
wb.save(filename)

# *********************** road crossing_D+T_concrete loc no and wayleave yes  *********************************************

roadcrossing_d_t_concrete_way = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Road Crossing') & (df['loc'] == False)
                         & (df['wayleave'] == True) & (df['material'] == 'Concrete') & (df['type'] == 'Distribution & Trunk') ]

roadcrossing_d_t_concrete_2x96_way = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Road Crossing') & (df['loc'] == False)
                         & (df['wayleave'] == True) & (df['material'] == 'Concrete') & (df['type'] == 'Distribution & Trunk')
                         & (df['96mm'] == '2x96')]

num_of_rows_rc_d_t_concrete_way = roadcrossing_d_t_concrete_way['length'].sum()

num_of_rows_rc_d_t_concrete_2x96_way = roadcrossing_d_t_concrete_2x96_way['length'].sum()

num_of_rows_rc_d_t_concrete_total_way = num_of_rows_rc_d_t_concrete_way + num_of_rows_rc_d_t_concrete_2x96_way
...
ws = wb[sheets[n]]
ws_tables = []
ws["K61"] = num_of_rows_rc_d_t_concrete_total_way
wb.save(filename)

# *********************** road crossing_D+T_unmade and grassverge loc no and wayleave yes  *********************************************

roadcrossing_d_t_grassverge_way = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Road Crossing') & (df['loc'] == False)
                         & (df['wayleave'] == True) & (df['material'] == 'Grass Verge') & (df['type'] == 'Distribution & Trunk')]

roadcrossing_d_t_unmade_way = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Road Crossing') & (df['loc'] == False)
                         & (df['wayleave'] == True) & (df['material'] == 'Unmade') & (df['type'] == 'Distribution & Trunk')]

roadcrossing_d_t_grassverge_2x96_way = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Road Crossing') & (df['loc'] == False)
                         & (df['wayleave'] == True) & (df['material'] == 'Grass Verge') & (df['type'] == 'Distribution & Trunk') & (df['96mm'] == '2x96')]

roadcrossing_d_t_unmade_2x96_way = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Road Crossing') & (df['loc'] == False)
                         & (df['wayleave'] == True) & (df['material'] == 'Unmade') & (df['type'] == 'Distribution & Trunk') & (df['96mm'] == '2x96')]


num_of_rows_rc_d_t_grassverge_way = roadcrossing_d_t_grassverge_way['length'].sum()

num_of_rows_rc_d_t_unmade_way = roadcrossing_d_t_unmade_way['length'].sum()

num_of_rows_rc_d_t_grassverge_2x96_way = roadcrossing_d_t_grassverge_2x96_way['length'].sum()

num_of_rows_rc_d_t_unmade_2x96_way = roadcrossing_d_t_unmade_2x96_way['length'].sum()

num_of_rows_rc_d_t_unmade_grassverge_total_way = num_of_rows_rc_d_t_grassverge_way + num_of_rows_rc_d_t_unmade_way + num_of_rows_rc_d_t_grassverge_2x96_way + num_of_rows_rc_d_t_unmade_2x96_way
...
ws = wb[sheets[n]]
ws_tables = []
ws["L61"] = num_of_rows_rc_d_t_unmade_grassverge_total_way
wb.save(filename)

# *********************** road crossing_D+T_tarmac loc no and wayleave yes  *********************************************

roadcrossing_d_t_tarmac_way = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Road Crossing') & (df['loc'] == False)
                         & (df['wayleave'] == True) & (df['material'] == 'Tarmac' ) & (df['type'] == 'Distribution & Trunk') ]

roadcrossing_d_t_tarmac_2x96_way = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Road Crossing') & (df['loc'] == False)
                         & (df['wayleave'] == True) & (df['material'] == 'Tarmac') & (df['type'] == 'Distribution & Trunk')
                         & (df['96mm'] == '2x96')]

num_of_rows_rc_d_t_tarmac_way = roadcrossing_d_t_tarmac_way['length'].sum()

num_of_rows_rc_d_t_tarmac_2x96_way = roadcrossing_d_t_tarmac_2x96_way['length'].sum()

num_of_rows_rc_d_t_tarmac_total_way = num_of_rows_rc_d_t_tarmac_way + num_of_rows_rc_d_t_tarmac_2x96_way
...
ws = wb[sheets[n]]
ws_tables = []
ws["M61"] = num_of_rows_rc_d_t_tarmac_total_way
wb.save(filename)

# *********************** road crossing_D_modular loc no and wayleave yes  *********************************************

roadcrossing_d_modular_way = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Road Crossing') & (df['loc'] == False)
                         & (df['wayleave'] == True) & (df['material'] == 'Modular' ) & (df['type'] == 'Distribution') ]

roadcrossing_d_modular_2x96_way = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Road Crossing') & (df['loc'] == False)
                         & (df['wayleave'] == True) & (df['material'] == 'Modular') & (df['type'] == 'Distribution')
                         & (df['96mm'] == '2x96')]

num_of_rows_rc_d_modular_way = roadcrossing_d_modular_way['length'].sum()

num_of_rows_rc_d_modular_2x96_way = roadcrossing_d_modular_2x96_way['length'].sum()

num_of_rows_rc_d_modular_total_way = num_of_rows_rc_d_modular_way + num_of_rows_rc_d_modular_2x96_way
...
ws = wb[sheets[n]]
ws_tables = []
ws["J62"] = num_of_rows_rc_d_modular_total_way
wb.save(filename)

# *********************** road crossing_D_concrete loc no and wayleave yes  *********************************************

roadcrossing_d_concrete_way = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Road Crossing') & (df['loc'] == False)
                         & (df['wayleave'] == True) & (df['material'] == 'Concrete') & (df['type'] == 'Distribution') ]

roadcrossing_d_concrete_2x96_way = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Road Crossing') & (df['loc'] == False)
                         & (df['wayleave'] == True) & (df['material'] == 'Concrete') & (df['type'] == 'Distribution')
                         & (df['96mm'] == '2x96')]

num_of_rows_rc_d_concrete_way = roadcrossing_d_concrete_way['length'].sum()

num_of_rows_rc_d_concrete_2x96_way = roadcrossing_d_concrete_2x96_way['length'].sum()

num_of_rows_rc_d_concrete_total_way = num_of_rows_rc_d_concrete_way + num_of_rows_rc_d_concrete_2x96_way
...
ws = wb[sheets[n]]
ws_tables = []
ws["K62"] = num_of_rows_rc_d_concrete_total_way
wb.save(filename)

# *********************** road crossing_D_unmade and grassverge loc no and wayleave yes  *********************************************

roadcrossing_d_grassverge_way = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Road Crossing') & (df['loc'] == False)
                         & (df['wayleave'] == True) & (df['material'] == 'Grass Verge') & (df['type'] == 'Distribution')]

roadcrossing_d_unmade_way = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Road Crossing') & (df['loc'] == False)
                         & (df['wayleave'] == True) & (df['material'] == 'Unmade') & (df['type'] == 'Distribution')]

roadcrossing_d_grassverge_2x96_way = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Road Crossing') & (df['loc'] == False)
                         & (df['wayleave'] == True) & (df['material'] == 'Grass Verge') & (df['type'] == 'Distribution') & (df['96mm'] == '2x96')]

roadcrossing_d_unmade_2x96_way = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Road Crossing') & (df['loc'] == False)
                         & (df['wayleave'] == True) & (df['material'] == 'Unmade') & (df['type'] == 'Distribution') & (df['96mm'] == '2x96')]


num_of_rows_rc_d_grassverge_way = roadcrossing_d_grassverge_way['length'].sum()

num_of_rows_rc_d_unmade_way = roadcrossing_d_unmade_way['length'].sum()

num_of_rows_rc_d_grassverge_2x96_way = roadcrossing_d_grassverge_2x96_way['length'].sum()

num_of_rows_rc_d_unmade_2x96_way = roadcrossing_d_unmade_2x96_way['length'].sum()

num_of_rows_rc_d_unmade_grassverge_total_way = num_of_rows_rc_d_grassverge_way + num_of_rows_rc_d_t_unmade_way + num_of_rows_rc_d_grassverge_2x96_way + num_of_rows_rc_d_unmade_2x96_way
...
ws = wb[sheets[n]]
ws_tables = []
ws["L62"] = num_of_rows_rc_d_unmade_grassverge_total_way
wb.save(filename)

# *********************** road crossing_D_tarmac loc no and wayleave yes  *********************************************

roadcrossing_d_tarmac_way = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Road Crossing') & (df['loc'] == False)
                         & (df['wayleave'] == True) & (df['material'] == 'Tarmac' ) & (df['type'] == 'Distribution') ]

roadcrossing_d_tarmac_2x96_way = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Road Crossing') & (df['loc'] == False)
                         & (df['wayleave'] == True) & (df['material'] == 'Tarmac') & (df['type'] == 'Distribution')
                         & (df['96mm'] == '2x96')]

num_of_rows_rc_d_tarmac_way = roadcrossing_d_tarmac_way['length'].sum()

num_of_rows_rc_d_tarmac_2x96_way = roadcrossing_d_tarmac_2x96_way['length'].sum()

num_of_rows_rc_d_tarmac_total_way = num_of_rows_rc_d_tarmac_way + num_of_rows_rc_d_tarmac_2x96_way
...
ws = wb[sheets[n]]
ws_tables = []
ws["M62"] = num_of_rows_rc_d_tarmac_total_way
wb.save(filename)

# *********************** road crossing_S_D_T_modular loc no and wayleave yes  *********************************************

roadcrossing_s_d_t_modular_way = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Road Crossing') & (df['loc'] == False)
                         & (df['wayleave'] == True) & (df['material'] == 'Modular' ) & (df['type'] == 'Acces, Distribution & Trunk') ]

roadcrossing_s_d_t_modular_2x96_way = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Road Crossing') & (df['loc'] == False)
                         & (df['wayleave'] == True) & (df['material'] == 'Modular') & (df['type'] == 'Acces, Distribution & Trunk')
                         & (df['96mm'] == '2x96')]

num_of_rows_rc_s_d_t_modular_way = roadcrossing_s_d_t_modular_way['length'].sum()

num_of_rows_rc_s_d_t_modular_2x96_way = roadcrossing_s_d_t_modular_2x96_way['length'].sum()

num_of_rows_rc_s_d_t_modular_total_way = num_of_rows_rc_s_d_t_modular_way + num_of_rows_rc_s_d_t_modular_2x96_way
...
ws = wb[sheets[n]]
ws_tables = []
ws["J63"] = num_of_rows_rc_s_d_t_modular_total_way
wb.save(filename)

# *********************** road crossing_S_D_T_concrete loc no and wayleave yes  *********************************************

roadcrossing_s_d_t_concrete_way = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Road Crossing') & (df['loc'] == False)
                         & (df['wayleave'] == True) & (df['material'] == 'Concrete') & (df['type'] == 'Acces, Distribution & Trunk') ]

roadcrossing_s_d_t_concrete_2x96_way = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Road Crossing') & (df['loc'] == False)
                         & (df['wayleave'] == True) & (df['material'] == 'Concrete') & (df['type'] == 'Acces, Distribution & Trunk')
                         & (df['96mm'] == '2x96')]

num_of_rows_rc_s_d_t_concrete_way = roadcrossing_s_d_t_concrete_way['length'].sum()

num_of_rows_rc_s_d_t_concrete_2x96_way = roadcrossing_s_d_t_concrete_2x96_way['length'].sum()

num_of_rows_rc_s_d_t_concrete_total_way = num_of_rows_rc_s_d_t_concrete_way + num_of_rows_rc_s_d_t_concrete_2x96_way
...
ws = wb[sheets[n]]
ws_tables = []
ws["K63"] = num_of_rows_rc_s_d_t_concrete_total_way
wb.save(filename)

# *********************** road crossing_S_D_T_unmade and grassverge loc no and wayleave yes  *********************************************

roadcrossing_s_d_t_grassverge_way = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Road Crossing') & (df['loc'] == False)
                         & (df['wayleave'] == True) & (df['material'] == 'Grass Verge') & (df['type'] == 'Acces, Distribution & Trunk')]

roadcrossing_s_d_t_unmade_way = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Road Crossing') & (df['loc'] == False)
                         & (df['wayleave'] == True) & (df['material'] == 'Unmade') & (df['type'] == 'Acces, Distribution & Trunk')]

roadcrossing_s_d_t_grassverge_2x96_way = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Road Crossing') & (df['loc'] == False)
                         & (df['wayleave'] == True) & (df['material'] == 'Grass Verge') & (df['type'] == 'Acces, Distribution & Trunk') & (df['96mm'] == '2x96')]

roadcrossing_s_d_t_unmade_2x96_way = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Road Crossing') & (df['loc'] == False)
                         & (df['wayleave'] == True) & (df['material'] == 'Unmade') & (df['type'] == 'Acces, Distribution & Trunk') & (df['96mm'] == '2x96')]


num_of_rows_rc_s_d_t_grassverge_way = roadcrossing_s_d_t_grassverge_way['length'].sum()

num_of_rows_rc_s_d_t_unmade_way = roadcrossing_s_d_t_unmade_way['length'].sum()

num_of_rows_rc_s_d_t_grassverge_2x96_way = roadcrossing_s_d_t_grassverge_2x96_way['length'].sum()

num_of_rows_rc_s_d_t_unmade_2x96_way = roadcrossing_s_d_t_unmade_2x96_way['length'].sum()

num_of_rows_rc_s_d_t_unmade_grassverge_total_way = num_of_rows_rc_s_d_t_grassverge_way + num_of_rows_rc_s_d_t_unmade_way + num_of_rows_rc_s_d_t_grassverge_2x96_way + num_of_rows_rc_s_d_t_unmade_2x96_way
...
ws = wb[sheets[n]]
ws_tables = []
ws["L63"] = num_of_rows_rc_s_d_t_unmade_grassverge_total_way
wb.save(filename)

# *********************** road crossing_S_D_T_tarmac loc no and wayleave yes  *********************************************

roadcrossing_s_d_t_tarmac_way = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Road Crossing') & (df['loc'] == False)
                         & (df['wayleave'] == True) & (df['material'] == 'Tarmac' ) & (df['type'] == 'Acces, Distribution & Trunk') ]

roadcrossing_s_d_t_tarmac_2x96_way = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Road Crossing') & (df['loc'] == False)
                         & (df['wayleave'] == True) & (df['material'] == 'Tarmac') & (df['type'] == 'Acces, Distribution & Trunk')
                         & (df['96mm'] == '2x96')]

num_of_rows_rc_s_d_t_tarmac_way = roadcrossing_s_d_t_tarmac_way['length'].sum()

num_of_rows_rc_s_d_t_tarmac_2x96_way = roadcrossing_s_d_t_tarmac_2x96_way['length'].sum()

num_of_rows_rc_s_d_t_tarmac_total_way = num_of_rows_rc_s_d_t_tarmac_way + num_of_rows_rc_s_d_t_tarmac_2x96_way
...
ws = wb[sheets[n]]
ws_tables = []
ws["M63"] = num_of_rows_rc_s_d_t_tarmac_total_way
wb.save(filename)

# *********************** road crossing_S_D_modular loc no and wayleave yes  *********************************************

roadcrossing_s_d_modular_way = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Road Crossing') & (df['loc'] == False)
                         & (df['wayleave'] == True) & (df['material'] == 'Modular' ) & (df['type'] == 'Access & Distribution') ]

roadcrossing_s_d_modular_2x96_way = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Road Crossing') & (df['loc'] == False)
                         & (df['wayleave'] == True) & (df['material'] == 'Modular') & (df['type'] == 'Access & Distribution')
                         & (df['96mm'] == '2x96')]

num_of_rows_rc_s_d_modular_way = roadcrossing_s_d_modular_way['length'].sum()

num_of_rows_rc_s_d_modular_2x96_way = roadcrossing_s_d_modular_2x96_way['length'].sum()

num_of_rows_rc_s_d_modular_total_way = num_of_rows_rc_s_d_modular_way + num_of_rows_rc_s_d_modular_2x96_way
...
ws = wb[sheets[n]]
ws_tables = []
ws["J64"] = num_of_rows_rc_s_d_modular_total_way
wb.save(filename)

# *********************** road crossing_S_D_concrete loc no and wayleave yes  *********************************************

roadcrossing_s_d_concrete_way = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Road Crossing') & (df['loc'] == False)
                         & (df['wayleave'] == True) & (df['material'] == 'Concrete') & (df['type'] == 'Access & Distribution') ]

roadcrossing_s_d_concrete_2x96_way = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Road Crossing') & (df['loc'] == False)
                         & (df['wayleave'] == True) & (df['material'] == 'Concrete') & (df['type'] == 'Access & Distribution')
                         & (df['96mm'] == '2x96')]

num_of_rows_rc_s_d_concrete_way = roadcrossing_s_d_concrete_way['length'].sum()

num_of_rows_rc_s_d_concrete_2x96_way = roadcrossing_s_d_concrete_2x96_way['length'].sum()

num_of_rows_rc_s_d_concrete_total_way = num_of_rows_rc_s_d_concrete_way + num_of_rows_rc_s_d_concrete_2x96_way
...
ws = wb[sheets[n]]
ws_tables = []
ws["K64"] = num_of_rows_rc_s_d_concrete_total_way
wb.save(filename)

# *********************** road crossing_S_D_unmade and grassverge loc no and wayleave yes  *********************************************

roadcrossing_s_d_grassverge_way = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Road Crossing') & (df['loc'] == False)
                         & (df['wayleave'] == True) & (df['material'] == 'Grass Verge') & (df['type'] == 'Access & Distribution')]

roadcrossing_s_d_unmade_way = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Road Crossing') & (df['loc'] == False)
                         & (df['wayleave'] == True) & (df['material'] == 'Unmade') & (df['type'] == 'Access & Distribution')]

roadcrossing_s_d_grassverge_2x96_way = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Road Crossing') & (df['loc'] == False)
                         & (df['wayleave'] == True) & (df['material'] == 'Grass Verge') & (df['type'] == 'Access & Distribution') & (df['96mm'] == '2x96')]

roadcrossing_s_d_unmade_2x96_way = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Road Crossing') & (df['loc'] == False)
                         & (df['wayleave'] == True) & (df['material'] == 'Unmade') & (df['type'] == 'Access & Distribution') & (df['96mm'] == '2x96')]


num_of_rows_rc_s_d_grassverge_way = roadcrossing_s_d_grassverge_way['length'].sum()

num_of_rows_rc_s_d_unmade_way = roadcrossing_s_d_unmade_way['length'].sum()

num_of_rows_rc_s_d_grassverge_2x96_way = roadcrossing_s_d_grassverge_2x96_way['length'].sum()

num_of_rows_rc_s_d_unmade_2x96_way = roadcrossing_s_d_unmade_2x96_way['length'].sum()

num_of_rows_rc_s_d_unmade_grassverge_total_way = num_of_rows_rc_s_d_grassverge_way + num_of_rows_rc_s_d_unmade_way + num_of_rows_rc_s_d_grassverge_2x96_way + num_of_rows_rc_s_d_unmade_2x96_way
...
ws = wb[sheets[n]]
ws_tables = []
ws["L64"] = num_of_rows_rc_s_d_unmade_grassverge_total_way
wb.save(filename)

# *********************** road crossing_S_D_tarmac loc no and wayleave yes  *********************************************

roadcrossing_s_d_tarmac_way = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Road Crossing') & (df['loc'] == False)
                         & (df['wayleave'] == True) & (df['material'] == 'Tarmac' ) & (df['type'] == 'Access & Distribution') ]

roadcrossing_s_d_tarmac_2x96_way = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Road Crossing') & (df['loc'] == False)
                         & (df['wayleave'] == True) & (df['material'] == 'Tarmac') & (df['type'] == 'Access & Distribution')
                         & (df['96mm'] == '2x96')]

num_of_rows_rc_s_d_tarmac_way = roadcrossing_s_d_tarmac_way['length'].sum()

num_of_rows_rc_s_d_tarmac_2x96_way = roadcrossing_s_d_tarmac_2x96_way['length'].sum()

num_of_rows_rc_s_d_tarmac_total_way = num_of_rows_rc_s_d_tarmac_way + num_of_rows_rc_s_d_tarmac_2x96_way
...
ws = wb[sheets[n]]
ws_tables = []
ws["M64"] = num_of_rows_rc_s_d_tarmac_total_way
wb.save(filename)

# *********************** road crossing_S_modular loc no and wayleave yes  *********************************************

roadcrossing_s_modular_way = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Road Crossing') & (df['loc'] == False)
                         & (df['wayleave'] == True) & (df['material'] == 'Modular' ) & (df['type'] == 'Access') ]

roadcrossing_s_modular_2x96_way = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Road Crossing') & (df['loc'] == False)
                         & (df['wayleave'] == True) & (df['material'] == 'Modular') & (df['type'] == 'Access')
                         & (df['96mm'] == '2x96')]

num_of_rows_rc_s_modular_way = roadcrossing_s_modular_way['length'].sum()

num_of_rows_rc_s_modular_2x96_way = roadcrossing_s_modular_2x96_way['length'].sum()

num_of_rows_rc_s_modular_total_way = num_of_rows_rc_s_modular_way + num_of_rows_rc_s_modular_2x96_way
...
ws = wb[sheets[n]]
ws_tables = []
ws["J65"] = num_of_rows_rc_s_modular_total_way
wb.save(filename)

# *********************** road crossing_S_concrete loc no and wayleave yes  *********************************************

roadcrossing_s_concrete_way = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Road Crossing') & (df['loc'] == False)
                         & (df['wayleave'] == True) & (df['material'] == 'Concrete') & (df['type'] == 'Access') ]

roadcrossing_s_concrete_2x96_way = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Road Crossing') & (df['loc'] == False)
                         & (df['wayleave'] == True) & (df['material'] == 'Concrete') & (df['type'] == 'Access')
                         & (df['96mm'] == '2x96')]

num_of_rows_rc_s_concrete_way = roadcrossing_s_concrete_way['length'].sum()

num_of_rows_rc_s_concrete_2x96_way = roadcrossing_s_concrete_2x96_way['length'].sum()

num_of_rows_rc_s_concrete_total_way = num_of_rows_rc_s_concrete_way + num_of_rows_rc_s_concrete_2x96_way
...
ws = wb[sheets[n]]
ws_tables = []
ws["K65"] = num_of_rows_rc_s_concrete_total_way
wb.save(filename)

# *********************** road crossing_S_unmade and grassverge loc no and wayleave yes  *********************************************

roadcrossing_s_grassverge_way = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Road Crossing') & (df['loc'] == False)
                         & (df['wayleave'] == True) & (df['material'] == 'Grass Verge') & (df['type'] == 'Access')]

roadcrossing_s_unmade_way = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Road Crossing') & (df['loc'] == False)
                         & (df['wayleave'] == True) & (df['material'] == 'Unmade') & (df['type'] == 'Access')]

roadcrossing_s_grassverge_2x96_way = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Road Crossing') & (df['loc'] == False)
                         & (df['wayleave'] == True) & (df['material'] == 'Grass Verge') & (df['type'] == 'Access') & (df['96mm'] == '2x96')]

roadcrossing_s_unmade_2x96_way = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Road Crossing') & (df['loc'] == False)
                         & (df['wayleave'] == True) & (df['material'] == 'Unmade') & (df['type'] == 'Access') & (df['96mm'] == '2x96')]


num_of_rows_rc_s_grassverge_way = roadcrossing_s_grassverge_way['length'].sum()

num_of_rows_rc_s_unmade_way = roadcrossing_s_unmade_way['length'].sum()

num_of_rows_rc_s_grassverge_2x96_way = roadcrossing_s_grassverge_2x96_way['length'].sum()

num_of_rows_rc_s_unmade_2x96_way = roadcrossing_s_unmade_2x96_way['length'].sum()

num_of_rows_rc_s_unmade_grassverge_total_way = num_of_rows_rc_s_grassverge_way + num_of_rows_rc_s_unmade_way + num_of_rows_rc_s_grassverge_2x96_way + num_of_rows_rc_s_unmade_2x96_way
...
ws = wb[sheets[n]]
ws_tables = []
ws["L65"] = num_of_rows_rc_s_unmade_grassverge_total_way
wb.save(filename)

# *********************** road crossing_S_tarmac loc no and wayleave yes  *********************************************

roadcrossing_s_tarmac_way = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Road Crossing') & (df['loc'] == False)
                         & (df['wayleave'] == True) & (df['material'] == 'Tarmac' ) & (df['type'] == 'Access') ]

roadcrossing_s_tarmac_2x96_way = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Road Crossing') & (df['loc'] == False)
                         & (df['wayleave'] == True) & (df['material'] == 'Tarmac') & (df['type'] == 'Access')
                         & (df['96mm'] == '2x96')]

num_of_rows_rc_s_tarmac_way = roadcrossing_s_tarmac_way['length'].sum()

num_of_rows_rc_s_tarmac_2x96_way = roadcrossing_s_tarmac_2x96_way['length'].sum()

num_of_rows_rc_s_tarmac_total_way = num_of_rows_rc_s_tarmac_way + num_of_rows_rc_s_tarmac_2x96_way
...
ws = wb[sheets[n]]
ws_tables = []
ws["M65"] = num_of_rows_rc_s_tarmac_total_way
wb.save(filename)

# *********************** road crossing_T_modular loc no and wayleave yes  *********************************************

roadcrossing_t_modular_way = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Road Crossing') & (df['loc'] == False)
                         & (df['wayleave'] == True) & (df['material'] == 'Modular' ) & (df['type'] == 'Trunk') ]

roadcrossing_t_modular_2x96_way = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Road Crossing') & (df['loc'] == False)
                         & (df['wayleave'] == True) & (df['material'] == 'Modular') & (df['type'] == 'Trunk')
                         & (df['96mm'] == '2x96')]

num_of_rows_rc_t_modular_way = roadcrossing_t_modular_way['length'].sum()

num_of_rows_rc_t_modular_2x96_way = roadcrossing_t_modular_2x96_way['length'].sum()

num_of_rows_rc_t_modular_total_way = num_of_rows_rc_t_modular_way + num_of_rows_rc_t_modular_2x96_way
...
ws = wb[sheets[n]]
ws_tables = []
ws["J66"] = num_of_rows_rc_t_modular_total_way
wb.save(filename)

# *********************** road crossing_T_concrete loc no and wayleave yes  *********************************************

roadcrossing_t_concrete_way = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Road Crossing') & (df['loc'] == False)
                         & (df['wayleave'] == True) & (df['material'] == 'Concrete') & (df['type'] == 'Trunk') ]

roadcrossing_t_concrete_2x96_way = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Road Crossing') & (df['loc'] == False)
                         & (df['wayleave'] == True) & (df['material'] == 'Concrete') & (df['type'] == 'Trunk')
                         & (df['96mm'] == '2x96')]

num_of_rows_rc_t_concrete_way = roadcrossing_t_concrete_way['length'].sum()

num_of_rows_rc_t_concrete_2x96_way = roadcrossing_t_concrete_2x96_way['length'].sum()

num_of_rows_rc_t_concrete_total_way = num_of_rows_rc_t_concrete_way + num_of_rows_rc_t_concrete_2x96_way
...
ws = wb[sheets[n]]
ws_tables = []
ws["K66"] = num_of_rows_rc_t_concrete_total_way
wb.save(filename)

# *********************** road crossing_T_unmade and grassverge loc no and wayleave yes  *********************************************

roadcrossing_t_grassverge_way = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Road Crossing') & (df['loc'] == False)
                         & (df['wayleave'] == True) & (df['material'] == 'Grass Verge') & (df['type'] == 'Trunk')]

roadcrossing_t_unmade_way = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Road Crossing') & (df['loc'] == False)
                         & (df['wayleave'] == True) & (df['material'] == 'Unmade') & (df['type'] == 'Trunk')]

roadcrossing_t_grassverge_2x96_way = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Road Crossing') & (df['loc'] == False)
                         & (df['wayleave'] == True) & (df['material'] == 'Grass Verge') & (df['type'] == 'Trunk') & (df['96mm'] == '2x96')]

roadcrossing_t_unmade_2x96_way = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Road Crossing') & (df['loc'] == False)
                         & (df['wayleave'] == True) & (df['material'] == 'Unmade') & (df['type'] == 'Trunk') & (df['96mm'] == '2x96')]


num_of_rows_rc_t_grassverge_way = roadcrossing_t_grassverge_way['length'].sum()

num_of_rows_rc_t_unmade_way = roadcrossing_t_unmade_way['length'].sum()

num_of_rows_rc_t_grassverge_2x96_way = roadcrossing_t_grassverge_2x96_way['length'].sum()

num_of_rows_rc_t_unmade_2x96_way = roadcrossing_t_unmade_2x96_way['length'].sum()

num_of_rows_rc_t_unmade_grassverge_total_way = num_of_rows_rc_t_grassverge_way + num_of_rows_rc_t_unmade_way + num_of_rows_rc_t_grassverge_2x96_way + num_of_rows_rc_t_unmade_2x96_way
...
ws = wb[sheets[n]]
ws_tables = []
ws["L66"] = num_of_rows_rc_t_unmade_grassverge_total_way
wb.save(filename)

# *********************** road crossing_T_tarmac loc no and wayleave yes  *********************************************

roadcrossing_t_tarmac_way = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Road Crossing') & (df['loc'] == False)
                         & (df['wayleave'] == True) & (df['material'] == 'Tarmac' ) & (df['type'] == 'Trunk') ]

roadcrossing_t_tarmac_2x96_way = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Road Crossing') & (df['loc'] == False)
                         & (df['wayleave'] == True) & (df['material'] == 'Tarmac') & (df['type'] == 'Trunk')
                         & (df['96mm'] == '2x96')]

num_of_rows_rc_t_tarmac_way = roadcrossing_t_tarmac_way['length'].sum()

num_of_rows_rc_t_tarmac_2x96_way = roadcrossing_t_tarmac_2x96_way['length'].sum()

num_of_rows_rc_t_tarmac_total_way = num_of_rows_rc_t_tarmac_way + num_of_rows_rc_t_tarmac_2x96_way
...
ws = wb[sheets[n]]
ws_tables = []
ws["M66"] = num_of_rows_rc_t_tarmac_total_way
wb.save(filename)

# *********************** carriageway_S+T_modular loc yes  *********************************************

carriageway_s_t_modular_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Carriageway') & (df['loc'] == True)
                         & (df['material'] == 'Modular' ) & (df['type'] == 'Access & Trunk') ]

carriageway_s_t_modular_2x96_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Carriageway') & (df['loc'] == True)
                         & (df['material'] == 'Modular') & (df['type'] == 'Access & Trunk')
                         & (df['96mm'] == '2x96')]

num_of_rows_cw_s_t_modular_loc = carriageway_s_t_modular_loc['length'].sum()

num_of_rows_cw_s_t_modular_2x96_loc = carriageway_s_t_modular_2x96_loc['length'].sum()

num_of_rows_cw_s_t_modular_total_loc = num_of_rows_cw_s_t_modular_loc + num_of_rows_cw_s_t_modular_2x96_loc
...
ws = wb[sheets[n]]
ws_tables = []
ws["F38"] = num_of_rows_cw_s_t_modular_total_loc
wb.save(filename)

# *********************** carriageway_S+T_concrete loc yes  *********************************************

carriageway_s_t_concrete_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Carriageway') & (df['loc'] == True)
                         & (df['material'] == 'Concrete') & (df['type'] == 'Access & Trunk') ]

carriageway_s_t_concrete_2x96_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Carriageway') & (df['loc'] == True)
                         & (df['material'] == 'Concrete') & (df['type'] == 'Access & Trunk')
                         & (df['96mm'] == '2x96')]

num_of_rows_cw_s_t_concrete_loc = carriageway_s_t_concrete_loc['length'].sum()

num_of_rows_cw_s_t_concrete_2x96_loc = carriageway_s_t_concrete_2x96_loc['length'].sum()

num_of_rows_cw_s_t_concrete_total_loc = num_of_rows_cw_s_t_concrete_loc + num_of_rows_cw_s_t_concrete_2x96_loc
...
ws = wb[sheets[n]]
ws_tables = []
ws["G38"] = num_of_rows_cw_s_t_concrete_total_loc
wb.save(filename)

# *********************** carriageway_S+T_unmade and grassverge loc yes  *********************************************

carriageway_s_t_grassverge_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Carriageway') & (df['loc'] == True)
                         & (df['material'] == 'Grass Verge') & (df['type'] == 'Access & Trunk')]

carriageway_s_t_unmade_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Carriageway') & (df['loc'] == True)
                         & (df['material'] == 'Unmade') & (df['type'] == 'Access & Trunk')]

carriageway_s_t_grassverge_2x96_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Carriageway') & (df['loc'] == True)
                         & (df['material'] == 'Grass Verge') & (df['type'] == 'Access & Trunk') & (df['96mm'] == '2x96')]

carriageway_s_t_unmade_2x96_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Carriageway') & (df['loc'] == True)
                         & (df['material'] == 'Unmade') & (df['type'] == 'Access & Trunk') & (df['96mm'] == '2x96')]


num_of_rows_cw_s_t_grassverge_loc = carriageway_s_t_grassverge_loc['length'].sum()

num_of_rows_cw_s_t_unmade_loc = carriageway_s_t_unmade_loc['length'].sum()

num_of_rows_cw_s_t_grassverge_2x96_loc = carriageway_s_t_grassverge_2x96_loc['length'].sum()

num_of_rows_cw_s_t_unmade_2x96_loc = carriageway_s_t_unmade_2x96_loc['length'].sum()

num_of_rows_cw_s_t_unmade_grassverge_total_loc = num_of_rows_cw_s_t_grassverge_loc + num_of_rows_cw_s_t_unmade_loc + num_of_rows_cw_s_t_grassverge_2x96_loc + num_of_rows_cw_s_t_unmade_2x96_loc
...
ws = wb[sheets[n]]
ws_tables = []
ws["H38"] = num_of_rows_cw_s_t_unmade_grassverge_total_loc
wb.save(filename)

# *********************** carriageway_S+T_tarmac loc yes  *********************************************

carriageway_s_t_tarmac_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Carriageway') & (df['loc'] == True)
                         & (df['material'] == 'Tarmac' ) & (df['type'] == 'Access & Trunk') ]

carriageway_s_t_tarmac_2x96_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Carriageway') & (df['loc'] == True)
                         & (df['material'] == 'Tarmac') & (df['type'] == 'Access & Trunk')
                         & (df['96mm'] == '2x96')]

num_of_rows_cw_s_t_tarmac_loc = carriageway_s_t_tarmac_loc['length'].sum()

num_of_rows_cw_s_t_tarmac_2x96_loc = carriageway_s_t_tarmac_2x96_loc['length'].sum()

num_of_rows_cw_s_t_tarmac_total_loc = num_of_rows_cw_s_t_tarmac_loc + num_of_rows_cw_s_t_tarmac_2x96_loc
...
ws = wb[sheets[n]]
ws_tables = []
ws["I38"] = num_of_rows_cw_s_t_tarmac_total_loc
wb.save(filename)

# *********************** carriageway_D+T_modular loc yes  *********************************************

carriageway_d_t_modular_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Carriageway') & (df['loc'] == True)
                         & (df['material'] == 'Modular' ) & (df['type'] == 'Distribution & Trunk') ]

carriageway_d_t_modular_2x96_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Carriageway') & (df['loc'] == True)
                         & (df['material'] == 'Modular') & (df['type'] == 'Distribution & Trunk')
                         & (df['96mm'] == '2x96')]

num_of_rows_cw_d_t_modular_loc = carriageway_d_t_modular_loc['length'].sum()

num_of_rows_cw_d_t_modular_2x96_loc = carriageway_d_t_modular_2x96_loc['length'].sum()

num_of_rows_cw_d_t_modular_total_loc = num_of_rows_cw_d_t_modular_loc + num_of_rows_cw_d_t_modular_2x96_loc
...
ws = wb[sheets[n]]
ws_tables = []
ws["F39"] = num_of_rows_cw_d_t_modular_total_loc
wb.save(filename)

# *********************** carriageway_D+T_concrete loc yes  *********************************************

carriageway_d_t_concrete_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Carriageway') & (df['loc'] == True)
                          & (df['material'] == 'Concrete') & (df['type'] == 'Distribution & Trunk') ]

carriageway_d_t_concrete_2x96_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Carriageway') & (df['loc'] == True)
                         & (df['material'] == 'Concrete') & (df['type'] == 'Distribution & Trunk')
                         & (df['96mm'] == '2x96')]

num_of_rows_cw_d_t_concrete_loc = carriageway_d_t_concrete_loc['length'].sum()

num_of_rows_cw_d_t_concrete_2x96_loc = carriageway_d_t_concrete_2x96_loc['length'].sum()

num_of_rows_cw_d_t_concrete_total_loc = num_of_rows_cw_d_t_concrete_loc + num_of_rows_cw_d_t_concrete_2x96_loc
...
ws = wb[sheets[n]]
ws_tables = []
ws["G39"] = num_of_rows_cw_d_t_concrete_total_loc
wb.save(filename)

# *********************** carriageway_D+T_unmade and grassverge loc yes  *********************************************

carriageway_d_t_grassverge_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Carriageway') & (df['loc'] == True)
                         & (df['material'] == 'Grass Verge') & (df['type'] == 'Distribution & Trunk')]

carriageway_d_t_unmade_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Carriageway') & (df['loc'] == True)
                         & (df['material'] == 'Unmade') & (df['type'] == 'Distribution & Trunk')]

carriageway_d_t_grassverge_2x96_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Carriageway') & (df['loc'] == True)
                         & (df['material'] == 'Grass Verge') & (df['type'] == 'Distribution & Trunk')
                         & (df['96mm'] == '2x96')]

carriageway_d_t_unmade_2x96_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Carriageway') & (df['loc'] == True)
                         & (df['material'] == 'Unmade') & (df['type'] == 'Distribution & Trunk')
                         & (df['96mm'] == '2x96')]


num_of_rows_cw_d_t_grassverge_loc = carriageway_d_t_grassverge_loc['length'].sum()

num_of_rows_cw_d_t_unmade_loc = carriageway_d_t_unmade_loc['length'].sum()

num_of_rows_cw_d_t_grassverge_2x96_loc = carriageway_d_t_grassverge_2x96_loc['length'].sum()

num_of_rows_cw_d_t_unmade_2x96_loc = carriageway_d_t_unmade_2x96_loc['length'].sum()

num_of_rows_cw_d_t_unmade_grassverge_total_loc = num_of_rows_cw_d_t_grassverge_loc + num_of_rows_cw_d_t_unmade_loc + num_of_rows_cw_d_t_grassverge_2x96_loc + num_of_rows_cw_d_t_unmade_2x96_loc
...
ws = wb[sheets[n]]
ws_tables = []
ws["H39"] = num_of_rows_cw_d_t_unmade_grassverge_total_loc
wb.save(filename)

# *********************** carriageway_D+T_tarmac loc yes  *********************************************

carriageway_d_t_tarmac_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Carriageway') & (df['loc'] == True)
                         & (df['material'] == 'Tarmac' ) & (df['type'] == 'Distribution & Trunk') ]

carriageway_d_t_tarmac_2x96_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Carriageway') & (df['loc'] == True)
                         & (df['material'] == 'Tarmac') & (df['type'] == 'Distribution & Trunk')
                         & (df['96mm'] == '2x96')]

num_of_rows_cw_d_t_tarmac_loc = carriageway_d_t_tarmac_loc['length'].sum()

num_of_rows_cw_d_t_tarmac_2x96_loc = carriageway_d_t_tarmac_2x96_loc['length'].sum()

num_of_rows_cw_d_t_tarmac_total_loc = num_of_rows_cw_d_t_tarmac_loc + num_of_rows_cw_d_t_tarmac_2x96_loc
...
ws = wb[sheets[n]]
ws_tables = []
ws["I39"] = num_of_rows_cw_d_t_tarmac_total_loc
wb.save(filename)

# *********************** carriageway_D_modular loc yes  *********************************************

carriageway_d_modular_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Carriageway') & (df['loc'] == True)
                         & (df['material'] == 'Modular' ) & (df['type'] == 'Distribution') ]

carriageway_d_modular_2x96_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Carriageway') & (df['loc'] == True)
                         & (df['material'] == 'Modular') & (df['type'] == 'Distribution')
                         & (df['96mm'] == '2x96')]

num_of_rows_cw_d_modular_loc = carriageway_d_modular_loc['length'].sum()

num_of_rows_cw_d_modular_2x96_loc = carriageway_d_modular_2x96_loc['length'].sum()

num_of_rows_cw_d_modular_total_loc = num_of_rows_cw_d_modular_loc + num_of_rows_cw_d_modular_2x96_loc
...
ws = wb[sheets[n]]
ws_tables = []
ws["F40"] = num_of_rows_cw_d_modular_total_loc
wb.save(filename)

# *********************** carriageway_D_concrete loc yes  *********************************************

carriageway_d_concrete_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Carriageway') & (df['loc'] == True)
                         & (df['material'] == 'Concrete') & (df['type'] == 'Distribution') ]

carriageway_d_concrete_2x96_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Carriageway') & (df['loc'] == True)
                         & (df['material'] == 'Concrete') & (df['type'] == 'Distribution')
                         & (df['96mm'] == '2x96')]

num_of_rows_cw_d_concrete_loc = carriageway_d_concrete_loc['length'].sum()

num_of_rows_cw_d_concrete_2x96_loc = carriageway_d_concrete_2x96_loc['length'].sum()

num_of_rows_cw_d_concrete_total_loc = num_of_rows_cw_d_concrete_loc + num_of_rows_cw_d_concrete_2x96_loc
...
ws = wb[sheets[n]]
ws_tables = []
ws["G40"] = num_of_rows_cw_d_concrete_total_loc
wb.save(filename)

# *********************** carriageway_D_unmade and grassverge loc yes  *********************************************

carriageway_d_grassverge_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Carriageway') & (df['loc'] == True)
                         & (df['material'] == 'Grass Verge') & (df['type'] == 'Distribution')]

carriageway_d_unmade_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Carriageway') & (df['loc'] == True)
                         & (df['material'] == 'Unmade') & (df['type'] == 'Distribution')]

carriageway_d_grassverge_2x96_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Carriageway') & (df['loc'] == True)
                         & (df['material'] == 'Grass Verge') & (df['type'] == 'Distribution')
                         & (df['96mm'] == '2x96')]

carriageway_d_unmade_2x96_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Carriageway') & (df['loc'] == True)
                         & (df['material'] == 'Unmade') & (df['type'] == 'Distribution')
                         & (df['96mm'] == '2x96')]


num_of_rows_cw_d_grassverge_loc = carriageway_d_grassverge_loc['length'].sum()

num_of_rows_cw_d_unmade_loc = carriageway_d_unmade_loc['length'].sum()

num_of_rows_cw_d_grassverge_2x96_loc = carriageway_d_grassverge_2x96_loc['length'].sum()

num_of_rows_cw_d_unmade_2x96_loc = carriageway_d_unmade_2x96_loc['length'].sum()

num_of_rows_cw_d_unmade_grassverge_total_loc = num_of_rows_cw_d_grassverge_loc + num_of_rows_cw_d_unmade_loc + num_of_rows_cw_d_grassverge_2x96_loc + num_of_rows_cw_d_unmade_2x96_loc
...
ws = wb[sheets[n]]
ws_tables = []
ws["H40"] = num_of_rows_cw_d_unmade_grassverge_total_loc
wb.save(filename)

# *********************** carriageway_D_tarmac loc yes  *********************************************

carriageway_d_tarmac_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Carriageway') & (df['loc'] == True)
                         & (df['material'] == 'Tarmac' ) & (df['type'] == 'Distribution') ]

carriageway_d_tarmac_2x96_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Carriageway') & (df['loc'] == True)
                         & (df['material'] == 'Tarmac') & (df['type'] == 'Distribution')
                         & (df['96mm'] == '2x96')]

num_of_rows_cw_d_tarmac_loc = carriageway_d_tarmac_loc['length'].sum()

num_of_rows_cw_d_tarmac_2x96_loc = carriageway_d_tarmac_2x96_loc['length'].sum()

num_of_rows_cw_d_tarmac_total_loc = num_of_rows_cw_d_tarmac_loc + num_of_rows_cw_d_tarmac_2x96_loc
...
ws = wb[sheets[n]]
ws_tables = []
ws["I40"] = num_of_rows_cw_d_tarmac_total_loc
wb.save(filename)

# *********************** carriageway_S+D+T_modular loc yes  *********************************************

carriageway_s_d_t_modular_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Carriageway') & (df['loc'] == True)
                         & (df['material'] == 'Modular' ) & (df['type'] == 'Acces, Distribution & Trunk') ]

carriageway_s_d_t_modular_2x96_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Carriageway') & (df['loc'] == True)
                         & (df['material'] == 'Modular') & (df['type'] == 'Acces, Distribution & Trunk')
                         & (df['96mm'] == '2x96')]

num_of_rows_cw_s_d_t_modular_loc = carriageway_s_d_t_modular_loc['length'].sum()

num_of_rows_cw_s_d_t_modular_2x96_loc = carriageway_s_d_t_modular_2x96_loc['length'].sum()

num_of_rows_cw_s_d_t_modular_total_loc = num_of_rows_cw_s_d_t_modular_loc + num_of_rows_cw_s_d_t_modular_2x96_loc
...
ws = wb[sheets[n]]
ws_tables = []
ws["F41"] = num_of_rows_cw_s_d_t_modular_total_loc
wb.save(filename)

# *********************** carriageway_S+D+T_concrete loc yes  *********************************************

carriageway_s_d_t_concrete_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Carriageway') & (df['loc'] == True)
                         & (df['material'] == 'Concrete') & (df['type'] == 'Acces, Distribution & Trunk') ]

carriageway_s_d_t_concrete_2x96_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Carriageway') & (df['loc'] == True)
                         & (df['material'] == 'Concrete') & (df['type'] == 'Acces, Distribution & Trunk')
                         & (df['96mm'] == '2x96')]

num_of_rows_cw_s_d_t_concrete_loc = carriageway_s_d_t_concrete_loc['length'].sum()

num_of_rows_cw_s_d_t_concrete_2x96_loc = carriageway_s_d_t_concrete_2x96_loc['length'].sum()

num_of_rows_cw_s_d_t_concrete_total_loc = num_of_rows_cw_s_d_t_concrete_loc + num_of_rows_cw_s_d_t_concrete_2x96_loc
...
ws = wb[sheets[n]]
ws_tables = []
ws["G41"] = num_of_rows_cw_s_d_t_concrete_total_loc
wb.save(filename)

# *********************** carriageway_S+D+T_unmade and grassverge loc yes  *********************************************

carriageway_s_d_t_grassverge_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Carriageway') & (df['loc'] == True)
                         & (df['material'] == 'Grass Verge') & (df['type'] == 'Acces, Distribution & Trunk')]

carriageway_s_d_t_unmade_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Carriageway') & (df['loc'] == True)
                         & (df['material'] == 'Unmade') & (df['type'] == 'Acces, Distribution & Trunk')]

carriageway_s_d_t_grassverge_2x96_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Carriageway') & (df['loc'] == True)
                         & (df['material'] == 'Grass Verge') & (df['type'] == 'Acces, Distribution & Trunk')
                         & (df['96mm'] == '2x96')]

carriageway_s_d_t_unmade_2x96_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Carriageway') & (df['loc'] == True)
                         & (df['material'] == 'Unmade') & (df['type'] == 'Acces, Distribution & Trunk')
                         & (df['96mm'] == '2x96')]


num_of_rows_cw_s_d_t_grassverge_loc = carriageway_s_d_t_grassverge_loc['length'].sum()

num_of_rows_cw_s_d_t_unmade_loc = carriageway_s_d_t_unmade_loc['length'].sum()

num_of_rows_cw_s_d_t_grassverge_2x96_loc = carriageway_s_d_t_grassverge_2x96_loc['length'].sum()

num_of_rows_cw_s_d_t_unmade_2x96_loc = carriageway_s_d_t_unmade_2x96_loc['length'].sum()

num_of_rows_cw_s_d_t_unmade_grassverge_total_loc = num_of_rows_cw_s_d_t_grassverge_loc + num_of_rows_cw_s_d_t_unmade_loc + num_of_rows_cw_s_d_t_grassverge_2x96_loc + num_of_rows_cw_s_d_t_unmade_2x96_loc
...
ws = wb[sheets[n]]
ws_tables = []
ws["H41"] = num_of_rows_cw_s_d_t_unmade_grassverge_total_loc
wb.save(filename)

# *********************** carriageway_S+D+T_tarmac loc yes  *********************************************

carriageway_s_d_t_tarmac_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Carriageway') & (df['loc'] == True)
                         & (df['material'] == 'Tarmac' ) & (df['type'] == 'Acces, Distribution & Trunk') ]

carriageway_s_d_t_tarmac_2x96_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Carriageway') & (df['loc'] == True)
                         & (df['material'] == 'Tarmac') & (df['type'] == 'Acces, Distribution & Trunk')
                         & (df['96mm'] == '2x96')]

num_of_rows_cw_s_d_t_tarmac_loc = carriageway_s_d_t_tarmac_loc['length'].sum()

num_of_rows_cw_s_d_t_tarmac_2x96_loc = carriageway_s_d_t_tarmac_2x96_loc['length'].sum()

num_of_rows_cw_s_d_t_tarmac_total_loc = num_of_rows_cw_s_d_t_tarmac_loc + num_of_rows_cw_s_d_t_tarmac_2x96_loc
...
ws = wb[sheets[n]]
ws_tables = []
ws["I41"] = num_of_rows_cw_s_d_t_tarmac_total_loc
wb.save(filename)

# *********************** carriageway_S+D_modular loc yes  *********************************************

carriageway_s_d_modular_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Carriageway') & (df['loc'] == True)
                         & (df['material'] == 'Modular' ) & (df['type'] == 'Access & Distribution') ]

carriageway_s_d_modular_2x96_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Carriageway') & (df['loc'] == True)
                         & (df['material'] == 'Modular') & (df['type'] == 'Access & Distribution')
                         & (df['96mm'] == '2x96')]

num_of_rows_cw_s_d_modular_loc = carriageway_s_d_modular_loc['length'].sum()

num_of_rows_cw_s_d_modular_2x96_loc = carriageway_s_d_modular_2x96_loc['length'].sum()

num_of_rows_cw_s_d_modular_total_loc = num_of_rows_cw_s_d_modular_loc + num_of_rows_cw_s_d_modular_2x96_loc
...
ws = wb[sheets[n]]
ws_tables = []
ws["F42"] = num_of_rows_cw_s_d_modular_total_loc
wb.save(filename)

# *********************** carriageway_S+D_concrete loc yes  *********************************************

carriageway_s_d_concrete_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Carriageway') & (df['loc'] == True)
                         & (df['material'] == 'Concrete') & (df['type'] == 'Access & Distribution') ]

carriageway_s_d_concrete_2x96_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Carriageway') & (df['loc'] == True)
                         & (df['material'] == 'Concrete') & (df['type'] == 'Access & Distribution')
                         & (df['96mm'] == '2x96')]

num_of_rows_cw_s_d_concrete_loc = carriageway_s_d_concrete_loc['length'].sum()

num_of_rows_cw_s_d_concrete_2x96_loc = carriageway_s_d_concrete_2x96_loc['length'].sum()

num_of_rows_cw_s_d_concrete_total_loc = num_of_rows_cw_s_d_concrete_loc + num_of_rows_cw_s_d_concrete_2x96_loc
...
ws = wb[sheets[n]]
ws_tables = []
ws["G42"] = num_of_rows_cw_s_d_concrete_total_loc
wb.save(filename)

# *********************** carriageway_S+D_unmade and grassverge loc yes  *********************************************

carriageway_s_d_grassverge_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Carriageway') & (df['loc'] == True)
                         & (df['material'] == 'Grass Verge') & (df['type'] == 'Access & Distribution')]

carriageway_s_d_unmade_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Carriageway') & (df['loc'] == True)
                         & (df['material'] == 'Unmade') & (df['type'] == 'Access & Distribution')]

carriageway_s_d_grassverge_2x96_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Carriageway') & (df['loc'] == True)
                         & (df['material'] == 'Grass Verge') & (df['type'] == 'Access & Distribution')
                         & (df['96mm'] == '2x96')]

carriageway_s_d_unmade_2x96_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Carriageway') & (df['loc'] == True)
                         & (df['material'] == 'Unmade') & (df['type'] == 'Access & Distribution')
                         & (df['96mm'] == '2x96')]


num_of_rows_cw_s_d_grassverge_loc = carriageway_s_d_grassverge_loc['length'].sum()

num_of_rows_cw_s_d_unmade_loc = carriageway_s_d_unmade_loc['length'].sum()

num_of_rows_cw_s_d_grassverge_2x96_loc = carriageway_s_d_grassverge_2x96_loc['length'].sum()

num_of_rows_cw_s_d_unmade_2x96_loc = carriageway_s_d_unmade_2x96_loc['length'].sum()

num_of_rows_cw_s_d_unmade_grassverge_total_loc = num_of_rows_cw_s_d_grassverge_loc + num_of_rows_cw_s_d_unmade_loc + num_of_rows_cw_s_d_grassverge_2x96_loc + num_of_rows_cw_s_d_unmade_2x96_loc
...
ws = wb[sheets[n]]
ws_tables = []
ws["H42"] = num_of_rows_cw_s_d_unmade_grassverge_total_loc
wb.save(filename)

# *********************** carriageway_S+D_tarmac loc yes  *********************************************

carriageway_s_d_tarmac_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Carriageway') & (df['loc'] == True)
                         & (df['material'] == 'Tarmac' ) & (df['type'] == 'Access & Distribution') ]

carriageway_s_d_tarmac_2x96_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Carriageway') & (df['loc'] == True)
                         & (df['material'] == 'Tarmac') & (df['type'] == 'Access & Distribution')
                         & (df['96mm'] == '2x96')]

num_of_rows_cw_s_d_tarmac_loc = carriageway_s_d_tarmac_loc['length'].sum()

num_of_rows_cw_s_d_tarmac_2x96_loc = carriageway_s_d_tarmac_2x96_loc['length'].sum()

num_of_rows_cw_s_d_tarmac_total_loc = num_of_rows_cw_s_d_tarmac_loc + num_of_rows_cw_s_d_tarmac_2x96_loc
...
ws = wb[sheets[n]]
ws_tables = []
ws["I42"] = num_of_rows_cw_s_d_tarmac_total_loc
wb.save(filename)

# *********************** carriageway_S_modular loc yes  *********************************************

carriageway_s_modular_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Carriageway') & (df['loc'] == True)
                         & (df['material'] == 'Modular' ) & (df['type'] == 'Access') ]

carriageway_s_modular_2x96_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Carriageway') & (df['loc'] == True)
                         & (df['material'] == 'Modular') & (df['type'] == 'Access')
                         & (df['96mm'] == '2x96')]

num_of_rows_cw_s_modular_loc = carriageway_s_modular_loc['length'].sum()

num_of_rows_cw_s_modular_2x96_loc = carriageway_s_modular_2x96_loc['length'].sum()

num_of_rows_cw_s_modular_total_loc = num_of_rows_cw_s_modular_loc + num_of_rows_cw_s_modular_2x96_loc
...
ws = wb[sheets[n]]
ws_tables = []
ws["F43"] = num_of_rows_cw_s_modular_total_loc
wb.save(filename)

# *********************** carriageway_S_concrete loc yes  *********************************************

carriageway_s_concrete_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Carriageway') & (df['loc'] == True)
                         & (df['material'] == 'Concrete') & (df['type'] == 'Access') ]

carriageway_s_concrete_2x96_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Carriageway') & (df['loc'] == True)
                         & (df['material'] == 'Concrete') & (df['type'] == 'Access')
                         & (df['96mm'] == '2x96')]

num_of_rows_cw_s_concrete_loc = carriageway_s_concrete_loc['length'].sum()

num_of_rows_cw_s_concrete_2x96_loc = carriageway_s_concrete_2x96_loc['length'].sum()

num_of_rows_cw_s_concrete_total_loc = num_of_rows_cw_s_concrete_loc + num_of_rows_cw_s_concrete_2x96_loc
...
ws = wb[sheets[n]]
ws_tables = []
ws["G43"] = num_of_rows_cw_s_concrete_total_loc
wb.save(filename)

# *********************** carriageway_S_unmade and grassverge loc yes  *********************************************

carriageway_s_grassverge_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Carriageway') & (df['loc'] == True)
                         & (df['material'] == 'Grass Verge') & (df['type'] == 'Access')]

carriageway_s_unmade_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Carriageway') & (df['loc'] == True)
                         & (df['material'] == 'Unmade') & (df['type'] == 'Access')]

carriageway_s_grassverge_2x96_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Carriageway') & (df['loc'] == True)
                         & (df['material'] == 'Grass Verge') & (df['type'] == 'Access')
                         & (df['96mm'] == '2x96')]

carriageway_s_unmade_2x96_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Carriageway') & (df['loc'] == True)
                         & (df['material'] == 'Unmade') & (df['type'] == 'Access')
                         & (df['96mm'] == '2x96')]


num_of_rows_cw_s_grassverge_loc = carriageway_s_grassverge_loc['length'].sum()

num_of_rows_cw_s_unmade_loc = carriageway_s_unmade_loc['length'].sum()

num_of_rows_cw_s_grassverge_2x96_loc = carriageway_s_grassverge_2x96_loc['length'].sum()

num_of_rows_cw_s_unmade_2x96_loc = carriageway_s_unmade_2x96_loc['length'].sum()

num_of_rows_cw_s_unmade_grassverge_total_loc = num_of_rows_cw_s_grassverge_loc + num_of_rows_cw_s_unmade_loc + num_of_rows_cw_s_grassverge_2x96_loc + num_of_rows_cw_s_unmade_2x96_loc
...
ws = wb[sheets[n]]
ws_tables = []
ws["H43"] = num_of_rows_cw_s_unmade_grassverge_total_loc
wb.save(filename)

# *********************** carriageway_S_tarmac loc yes  *********************************************

carriageway_s_tarmac_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Carriageway') & (df['loc'] == True)
                         & (df['material'] == 'Tarmac' ) & (df['type'] == 'Access') ]

carriageway_s_tarmac_2x96_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Carriageway') & (df['loc'] == True)
                         & (df['material'] == 'Tarmac') & (df['type'] == 'Access')
                         & (df['96mm'] == '2x96')]

num_of_rows_cw_s_tarmac_loc = carriageway_s_tarmac_loc['length'].sum()

num_of_rows_cw_s_tarmac_2x96_loc = carriageway_s_tarmac_2x96_loc['length'].sum()

num_of_rows_cw_s_tarmac_total_loc = num_of_rows_cw_s_tarmac_loc + num_of_rows_cw_s_tarmac_2x96_loc
...
ws = wb[sheets[n]]
ws_tables = []
ws["I43"] = num_of_rows_cw_s_tarmac_total_loc
wb.save(filename)

# *********************** carriageway_T_modular loc yes  *********************************************

carriageway_t_modular_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Carriageway') & (df['loc'] == True)
                         & (df['material'] == 'Modular' ) & (df['type'] == 'Trunk') ]

carriageway_t_modular_2x96_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Carriageway') & (df['loc'] == True)
                         & (df['material'] == 'Modular') & (df['type'] == 'Trunk')
                         & (df['96mm'] == '2x96')]

num_of_rows_cw_t_modular_loc = carriageway_t_modular_loc['length'].sum()

num_of_rows_cw_t_modular_2x96_loc = carriageway_t_modular_2x96_loc['length'].sum()

num_of_rows_cw_t_modular_total_loc = num_of_rows_cw_t_modular_loc + num_of_rows_cw_t_modular_2x96_loc
...
ws = wb[sheets[n]]
ws_tables = []
ws["F44"] = num_of_rows_cw_t_modular_total_loc
wb.save(filename)

# *********************** carriageway_T_concrete loc yes  *********************************************

carriageway_t_concrete_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Carriageway') & (df['loc'] == True)
                         & (df['material'] == 'Concrete') & (df['type'] == 'Trunk') ]

carriageway_t_concrete_2x96_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Carriageway') & (df['loc'] == True)
                         & (df['material'] == 'Concrete') & (df['type'] == 'Trunk')
                         & (df['96mm'] == '2x96')]

num_of_rows_cw_t_concrete_loc = carriageway_t_concrete_loc['length'].sum()

num_of_rows_cw_t_concrete_2x96_loc = carriageway_t_concrete_2x96_loc['length'].sum()

num_of_rows_cw_t_concrete_total_loc = num_of_rows_cw_t_concrete_loc + num_of_rows_cw_t_concrete_2x96_loc
...
ws = wb[sheets[n]]
ws_tables = []
ws["G44"] = num_of_rows_cw_t_concrete_total_loc
wb.save(filename)

# *********************** carriageway_t_unmade and grassverge loc yes  *********************************************

carriageway_t_grassverge_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Carriageway') & (df['loc'] == True)
                         & (df['material'] == 'Grass Verge') & (df['type'] == 'Trunk')]

carriageway_t_unmade_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Carriageway') & (df['loc'] == True)
                         & (df['material'] == 'Unmade') & (df['type'] == 'Trunk')]

carriageway_t_grassverge_2x96_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Carriageway') & (df['loc'] == True)
                         & (df['material'] == 'Grass Verge') & (df['type'] == 'Trunk')
                         & (df['96mm'] == '2x96')]

carriageway_t_unmade_2x96_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Carriageway') & (df['loc'] == True)
                         & (df['material'] == 'Unmade') & (df['type'] == 'Trunk')
                         & (df['96mm'] == '2x96')]


num_of_rows_cw_t_grassverge_loc = carriageway_t_grassverge_loc['length'].sum()

num_of_rows_cw_t_unmade_loc = carriageway_t_unmade_loc['length'].sum()

num_of_rows_cw_t_grassverge_2x96_loc = carriageway_t_grassverge_2x96_loc['length'].sum()

num_of_rows_cw_t_unmade_2x96_loc = carriageway_t_unmade_2x96_loc['length'].sum()

num_of_rows_cw_t_unmade_grassverge_total_loc = num_of_rows_cw_t_grassverge_loc + num_of_rows_cw_t_unmade_loc + num_of_rows_cw_t_grassverge_2x96_loc + num_of_rows_cw_t_unmade_2x96_loc
...
ws = wb[sheets[n]]
ws_tables = []
ws["H44"] = num_of_rows_cw_t_unmade_grassverge_total_loc
wb.save(filename)

# *********************** carriageway_T_tarmac loc yes  *********************************************

carriageway_t_tarmac_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Carriageway') & (df['loc'] == True)
                         & (df['material'] == 'Tarmac' ) & (df['type'] == 'Trunk') ]

carriageway_t_tarmac_2x96_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Carriageway') & (df['loc'] == True)
                         & (df['material'] == 'Tarmac') & (df['type'] == 'Trunk')
                         & (df['96mm'] == '2x96')]

num_of_rows_cw_t_tarmac_loc = carriageway_t_tarmac_loc['length'].sum()

num_of_rows_cw_t_tarmac_2x96_loc = carriageway_t_tarmac_2x96_loc['length'].sum()

num_of_rows_cw_t_tarmac_total_loc = num_of_rows_cw_t_tarmac_loc + num_of_rows_cw_t_tarmac_2x96_loc
...
ws = wb[sheets[n]]
ws_tables = []
ws["I44"] = num_of_rows_cw_t_tarmac_total_loc
wb.save(filename)

# *********************** footway_S+T_modular loc yes  *********************************************

footway_s_t_modular_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Footway') & (df['loc'] == True)
                         & (df['material'] == 'Modular' ) & (df['type'] == 'Access & Trunk') ]

footway_s_t_modular_2x96_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Footway') & (df['loc'] == True)
                         & (df['material'] == 'Modular') & (df['type'] == 'Access & Trunk')
                         & (df['96mm'] == '2x96')]

num_of_rows_fw_s_t_modular_loc = footway_s_t_modular_loc['length'].sum()

num_of_rows_fw_s_t_modular_2x96_loc = footway_s_t_modular_2x96_loc['length'].sum()

num_of_rows_fw_s_t_modular_total_loc = num_of_rows_fw_s_t_modular_loc + num_of_rows_fw_s_t_modular_2x96_loc
...
ws = wb[sheets[n]]
ws_tables = []
ws["F49"] = num_of_rows_fw_s_t_modular_total_loc
wb.save(filename)

# *********************** footway_S+T_concrete loc yes  *********************************************

footway_s_t_concrete_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Footway') & (df['loc'] == True)
                         & (df['material'] == 'Concrete') & (df['type'] == 'Access & Trunk') ]

footway_s_t_concrete_2x96_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Footway') & (df['loc'] == True)
                         & (df['material'] == 'Concrete') & (df['type'] == 'Access & Trunk')
                         & (df['96mm'] == '2x96')]

num_of_rows_fw_s_t_concrete_loc = footway_s_t_concrete_loc['length'].sum()

num_of_rows_fw_s_t_concrete_2x96_loc = footway_s_t_concrete_2x96_loc['length'].sum()

num_of_rows_fw_s_t_concrete_total_loc = num_of_rows_fw_s_t_concrete_loc + num_of_rows_fw_s_t_concrete_2x96_loc
...
ws = wb[sheets[n]]
ws_tables = []
ws["G49"] = num_of_rows_fw_s_t_concrete_total_loc
wb.save(filename)

# *********************** footway_S+T_unmade and grassverge loc yes  *********************************************

footway_s_t_grassverge_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Footway') & (df['loc'] == True)
                         & (df['material'] == 'Grass Verge') & (df['type'] == 'Access & Trunk')]

footway_s_t_unmade_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Footway') & (df['loc'] == True)
                         & (df['material'] == 'Unmade') & (df['type'] == 'Access & Trunk')]

footway_s_t_grassverge_2x96_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Footway') & (df['loc'] == True)
                         & (df['material'] == 'Grass Verge') & (df['type'] == 'Access & Trunk') & (df['96mm'] == '2x96')]

footway_s_t_unmade_2x96_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Footway') & (df['loc'] == True)
                         & (df['material'] == 'Unmade') & (df['type'] == 'Access & Trunk') & (df['96mm'] == '2x96')]


num_of_rows_fw_s_t_grassverge_loc = footway_s_t_grassverge_loc['length'].sum()

num_of_rows_fw_s_t_unmade_loc = footway_s_t_unmade_loc['length'].sum()

num_of_rows_fw_s_t_grassverge_2x96_loc = footway_s_t_grassverge_2x96_loc['length'].sum()

num_of_rows_fw_s_t_unmade_2x96_loc = footway_s_t_unmade_2x96_loc['length'].sum()

num_of_rows_fw_s_t_unmade_grassverge_total_loc = num_of_rows_fw_s_t_grassverge_loc + num_of_rows_fw_s_t_unmade_loc + num_of_rows_fw_s_t_grassverge_2x96_loc + num_of_rows_fw_s_t_unmade_2x96_loc
...
ws = wb[sheets[n]]
ws_tables = []
ws["H49"] = num_of_rows_fw_s_t_unmade_grassverge_total_loc
wb.save(filename)

# *********************** footway_S+T_tarmac loc yes  *********************************************

footway_s_t_tarmac_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Footway') & (df['loc'] == True)
                         & (df['material'] == 'Tarmac' ) & (df['type'] == 'Access & Trunk') ]

footway_s_t_tarmac_2x96_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Footway') & (df['loc'] == True)
                         & (df['material'] == 'Tarmac') & (df['type'] == 'Access & Trunk')
                         & (df['96mm'] == '2x96')]

num_of_rows_fw_s_t_tarmac_loc = footway_s_t_tarmac_loc['length'].sum()

num_of_rows_fw_s_t_tarmac_2x96_loc = footway_s_t_tarmac_2x96_loc['length'].sum()

num_of_rows_fw_s_t_tarmac_total_loc = num_of_rows_fw_s_t_tarmac_loc + num_of_rows_fw_s_t_tarmac_2x96_loc
...
ws = wb[sheets[n]]
ws_tables = []
ws["I49"] = num_of_rows_fw_s_t_tarmac_total_loc
wb.save(filename)

# *********************** footway_D+T_modular loc yes  *********************************************

footway_d_t_modular_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Footway') & (df['loc'] == True)
                         & (df['material'] == 'Modular' ) & (df['type'] == 'Distribution & Trunk') ]

footway_d_t_modular_2x96_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Footway') & (df['loc'] == True)
                         & (df['material'] == 'Modular') & (df['type'] == 'Distribution & Trunk')
                         & (df['96mm'] == '2x96')]

num_of_rows_fw_d_t_modular_loc = footway_d_t_modular_loc['length'].sum()

num_of_rows_fw_d_t_modular_2x96_loc = footway_d_t_modular_2x96_loc['length'].sum()

num_of_rows_fw_d_t_modular_total_loc = num_of_rows_fw_d_t_modular_loc + num_of_rows_fw_d_t_modular_2x96_loc
...
ws = wb[sheets[n]]
ws_tables = []
ws["F50"] = num_of_rows_fw_d_t_modular_total_loc
wb.save(filename)

# *********************** footway_D+T_concrete loc yes  *********************************************

footway_d_t_concrete_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Footway') & (df['loc'] == True)
                         & (df['material'] == 'Concrete') & (df['type'] == 'Distribution & Trunk') ]

footway_d_t_concrete_2x96_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Footway') & (df['loc'] == True)
                         & (df['material'] == 'Concrete') & (df['type'] == 'Distribution & Trunk')
                         & (df['96mm'] == '2x96')]

num_of_rows_fw_d_t_concrete_loc = footway_d_t_concrete_loc['length'].sum()

num_of_rows_fw_d_t_concrete_2x96_loc = footway_d_t_concrete_2x96_loc['length'].sum()

num_of_rows_fw_d_t_concrete_total_loc = num_of_rows_fw_d_t_concrete_loc + num_of_rows_fw_d_t_concrete_2x96_loc
...
ws = wb[sheets[n]]
ws_tables = []
ws["G50"] = num_of_rows_fw_d_t_concrete_total_loc
wb.save(filename)

# *********************** footway_D+T_unmade and grassverge loc yes  *********************************************

footway_d_t_grassverge_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Footway') & (df['loc'] == True)
                         & (df['material'] == 'Grass Verge') & (df['type'] == 'Distribution & Trunk')]

footway_d_t_unmade_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Footway') & (df['loc'] == True)
                         & (df['material'] == 'Unmade') & (df['type'] == 'Distribution & Trunk')]

footway_d_t_grassverge_2x96_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Footway') & (df['loc'] == True)
                         & (df['material'] == 'Grass Verge') & (df['type'] == 'Distribution & Trunk') & (df['96mm'] == '2x96')]

footway_d_t_unmade_2x96_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Footway') & (df['loc'] == True)
                         & (df['material'] == 'Unmade') & (df['type'] == 'Distribution & Trunk') & (df['96mm'] == '2x96')]


num_of_rows_fw_d_t_grassverge_loc = footway_d_t_grassverge_loc['length'].sum()

num_of_rows_fw_d_t_unmade_loc = footway_d_t_unmade_loc['length'].sum()

num_of_rows_fw_d_t_grassverge_2x96_loc = footway_d_t_grassverge_2x96_loc['length'].sum()

num_of_rows_fw_d_t_unmade_2x96_loc = footway_d_t_unmade_2x96_loc['length'].sum()

num_of_rows_fw_d_t_unmade_grassverge_total_loc = num_of_rows_fw_d_t_grassverge_loc + num_of_rows_fw_d_t_unmade_loc + num_of_rows_fw_d_t_grassverge_2x96_loc + num_of_rows_fw_d_t_unmade_2x96_loc
...
ws = wb[sheets[n]]
ws_tables = []
ws["H50"] = num_of_rows_fw_d_t_unmade_grassverge_total_loc
wb.save(filename)

# *********************** footway_D+T_tarmac loc yes  *********************************************

footway_d_t_tarmac_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Footway') & (df['loc'] == True)
                         & (df['material'] == 'Tarmac' ) & (df['type'] == 'Distribution & Trunk') ]

footway_d_t_tarmac_2x96_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Footway') & (df['loc'] == True)
                         & (df['material'] == 'Tarmac') & (df['type'] == 'Distribution & Trunk')
                         & (df['96mm'] == '2x96')]

num_of_rows_fw_d_t_tarmac_loc = footway_d_t_tarmac_loc['length'].sum()

num_of_rows_fw_d_t_tarmac_2x96_loc = footway_d_t_tarmac_2x96_loc['length'].sum()

num_of_rows_fw_d_t_tarmac_total_loc = num_of_rows_fw_d_t_tarmac_loc + num_of_rows_fw_d_t_tarmac_2x96_loc
...
ws = wb[sheets[n]]
ws_tables = []
ws["I50"] = num_of_rows_fw_d_t_tarmac_total_loc
wb.save(filename)

# *********************** footway_D_modular loc yes  *********************************************

footway_d_modular_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Footway') & (df['loc'] == True)
                         & (df['material'] == 'Modular' ) & (df['type'] == 'Distribution') ]

footway_d_modular_2x96_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Footway') & (df['loc'] == True)
                         & (df['material'] == 'Modular') & (df['type'] == 'Distribution')
                         & (df['96mm'] == '2x96')]

num_of_rows_fw_d_modular_loc = footway_d_modular_loc['length'].sum()

num_of_rows_fw_d_modular_2x96_loc = footway_d_modular_2x96_loc['length'].sum()

num_of_rows_fw_d_modular_total_loc = num_of_rows_fw_d_modular_loc + num_of_rows_fw_d_modular_2x96_loc
...
ws = wb[sheets[n]]
ws_tables = []
ws["F51"] = num_of_rows_fw_d_modular_total_loc
wb.save(filename)


# *********************** footway_D_concrete loc yes  *********************************************

footway_d_concrete_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Footway') & (df['loc'] == True)
                         & (df['material'] == 'Concrete') & (df['type'] == 'Distribution') ]

footway_d_concrete_2x96_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Footway') & (df['loc'] == False)
                         & (df['material'] == 'Concrete') & (df['type'] == 'Distribution')
                         & (df['96mm'] == '2x96')]

num_of_rows_fw_d_concrete_loc = footway_d_concrete_loc['length'].sum()

num_of_rows_fw_d_concrete_2x96_loc = footway_d_concrete_2x96_loc['length'].sum()

num_of_rows_fw_d_concrete_total_loc = num_of_rows_fw_d_concrete_loc + num_of_rows_fw_d_concrete_2x96_loc
...
ws = wb[sheets[n]]
ws_tables = []
ws["G51"] = num_of_rows_fw_d_concrete_total_loc
wb.save(filename)

# *********************** footway_D_unmade and grassverge loc yes  *********************************************

footway_d_grassverge_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Footway') & (df['loc'] == True)
                         & (df['material'] == 'Grass Verge') & (df['type'] == 'Distribution')]

footway_d_unmade_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Footway') & (df['loc'] == True)
                         & (df['material'] == 'Unmade') & (df['type'] == 'Distribution')]

footway_d_grassverge_2x96_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Footway') & (df['loc'] == True)
                         & (df['material'] == 'Grass Verge') & (df['type'] == 'Distribution') & (df['96mm'] == '2x96')]

footway_d_unmade_2x96_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Footway') & (df['loc'] == True)
                         & (df['material'] == 'Unmade') & (df['type'] == 'Distribution') & (df['96mm'] == '2x96')]


num_of_rows_fw_d_grassverge_loc = footway_d_grassverge_loc['length'].sum()

num_of_rows_fw_d_unmade_loc = footway_d_unmade_loc['length'].sum()

num_of_rows_fw_d_grassverge_2x96_loc = footway_d_grassverge_2x96_loc['length'].sum()

num_of_rows_fw_d_unmade_2x96_loc = footway_d_unmade_2x96_loc['length'].sum()

num_of_rows_fw_d_unmade_grassverge_total_loc = num_of_rows_fw_d_grassverge_loc + num_of_rows_fw_d_unmade_loc + num_of_rows_fw_d_grassverge_2x96_loc + num_of_rows_fw_d_unmade_2x96_loc
...
ws = wb[sheets[n]]
ws_tables = []
ws["H51"] = num_of_rows_fw_d_unmade_grassverge_total_loc
wb.save(filename)

# *********************** footway_D_tarmac loc yes  *********************************************

footway_d_tarmac_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Footway') & (df['loc'] == True)
                         & (df['material'] == 'Tarmac' ) & (df['type'] == 'Distribution') ]

footway_d_tarmac_2x96_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Footway') & (df['loc'] == True)
                         & (df['material'] == 'Tarmac') & (df['type'] == 'Distribution')
                         & (df['96mm'] == '2x96')]

num_of_rows_fw_d_tarmac_loc = footway_d_tarmac_loc['length'].sum()

num_of_rows_fw_d_tarmac_2x96_loc = footway_d_tarmac_2x96_loc['length'].sum()

num_of_rows_fw_d_tarmac_total_loc = num_of_rows_fw_d_tarmac_loc + num_of_rows_fw_d_tarmac_2x96_loc
...
ws = wb[sheets[n]]
ws_tables = []
ws["I51"] = num_of_rows_fw_d_tarmac_total_loc
wb.save(filename)

# *********************** footway_S_D_T_modular loc yes  *********************************************

footway_s_d_t_modular_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Footway') & (df['loc'] == True)
                         & (df['material'] == 'Modular' ) & (df['type'] == 'Acces, Distribution & Trunk') ]

footway_s_d_t_modular_2x96_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Footway') & (df['loc'] == True)
                         & (df['material'] == 'Modular') & (df['type'] == 'Acces, Distribution & Trunk')
                         & (df['96mm'] == '2x96')]

num_of_rows_fw_s_d_t_modular_loc = footway_s_d_t_modular_loc['length'].sum()

num_of_rows_fw_s_d_t_modular_2x96_loc = footway_s_d_t_modular_2x96_loc['length'].sum()

num_of_rows_fw_s_d_t_modular_total_loc = num_of_rows_fw_s_d_t_modular_loc + num_of_rows_fw_s_d_t_modular_2x96_loc
...
ws = wb[sheets[n]]
ws_tables = []
ws["F52"] = num_of_rows_fw_s_d_t_modular_total_loc
wb.save(filename)


# *********************** footway_S+D+T_concrete loc yes  *********************************************

footway_s_d_t_concrete_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Footway') & (df['loc'] == True)
                         (df['material'] == 'Concrete') & (df['type'] == 'Acces, Distribution & Trunk') ]

footway_s_d_t_concrete_2x96_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Footway') & (df['loc'] == True)
                         (df['material'] == 'Concrete') & (df['type'] == 'Acces, Distribution & Trunk')
                         & (df['96mm'] == '2x96')]

num_of_rows_fw_s_d_t_concrete_loc = footway_s_d_t_concrete_loc['length'].sum()

num_of_rows_fw_s_d_t_concrete_2x96_loc = footway_s_d_t_concrete_2x96_loc['length'].sum()

num_of_rows_fw_s_d_t_concrete_total_loc = num_of_rows_fw_s_d_t_concrete_loc + num_of_rows_fw_s_d_t_concrete_2x96_loc
...
ws = wb[sheets[n]]
ws_tables = []
ws["G52"] = num_of_rows_fw_s_d_t_concrete_total_loc
wb.save(filename)

# *********************** footway_S+D+T_unmade and grassverge loc yes  *********************************************

footway_s_d_t_grassverge_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Footway') & (df['loc'] == True)
                         & (df['material'] == 'Grass Verge') & (df['type'] == 'Acces, Distribution & Trunk')]

footway_s_d_t_unmade_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Footway') & (df['loc'] == True)
                         & (df['material'] == 'Unmade') & (df['type'] == 'Acces, Distribution & Trunk')]

footway_s_d_t_grassverge_2x96_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Footway') & (df['loc'] == True)
                         & (df['material'] == 'Grass Verge') & (df['type'] == 'Acces, Distribution & Trunk') & (df['96mm'] == '2x96')]

footway_s_d_t_unmade_2x96_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Footway') & (df['loc'] == True)
                         & (df['material'] == 'Unmade') & (df['type'] == 'Acces, Distribution & Trunk') & (df['96mm'] == '2x96')]


num_of_rows_fw_s_d_t_grassverge_loc = footway_s_d_t_grassverge_loc['length'].sum()

num_of_rows_fw_s_d_t_unmade_loc = footway_s_d_t_unmade_loc['length'].sum()

num_of_rows_fw_s_d_t_grassverge_2x96_loc = footway_s_d_t_grassverge_2x96_loc['length'].sum()

num_of_rows_fw_s_d_t_unmade_2x96_loc = footway_s_d_t_unmade_2x96_loc['length'].sum()

num_of_rows_fw_s_d_t_unmade_grassverge_total_loc = num_of_rows_fw_s_d_t_grassverge_loc + num_of_rows_fw_s_d_t_unmade_loc + num_of_rows_fw_s_d_t_grassverge_2x96_loc + num_of_rows_fw_s_d_t_unmade_2x96_loc
...
ws = wb[sheets[n]]
ws_tables = []
ws["H52"] = num_of_rows_fw_s_d_t_unmade_grassverge_total_loc
wb.save(filename)

# *********************** footway_S+D+T_tarmac loc yes  *********************************************

footway_s_d_t_tarmac_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Footway') & (df['loc'] == True)
                         & (df['material'] == 'Tarmac' ) & (df['type'] == 'Acces, Distribution & Trunk') ]

footway_s_d_t_tarmac_2x96_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Footway') & (df['loc'] == True)
                         & (df['material'] == 'Tarmac') & (df['type'] == 'Acces, Distribution & Trunk')
                         & (df['96mm'] == '2x96')]

num_of_rows_fw_s_d_t_tarmac_loc = footway_s_d_t_tarmac_loc['length'].sum()

num_of_rows_fw_s_d_t_tarmac_2x96_loc = footway_s_d_t_tarmac_2x96_loc['length'].sum()

num_of_rows_fw_s_d_t_tarmac_total_loc = num_of_rows_fw_s_d_t_tarmac_loc + num_of_rows_fw_s_d_t_tarmac_2x96_loc
...
ws = wb[sheets[n]]
ws_tables = []
ws["I52"] = num_of_rows_fw_s_d_t_tarmac_total_loc
wb.save(filename)

# *********************** footway_S+D_modular loc yes  *********************************************

footway_s_d_modular_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Footway') & (df['loc'] == True)
                         & (df['material'] == 'Modular' ) & (df['type'] == 'Access & Distribution') ]

footway_s_d_modular_2x96_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Footway') & (df['loc'] == True)
                         & (df['material'] == 'Modular') & (df['type'] == 'Access & Distribution')
                         & (df['96mm'] == '2x96')]

num_of_rows_fw_s_d_modular_loc = footway_s_d_modular_loc['length'].sum()

num_of_rows_fw_s_d_modular_2x96_loc = footway_s_d_modular_2x96_loc['length'].sum()

num_of_rows_fw_s_d_modular_total_loc = num_of_rows_fw_s_d_modular_loc + num_of_rows_fw_s_d_modular_2x96_loc
...
ws = wb[sheets[n]]
ws_tables = []
ws["F53"] = num_of_rows_fw_s_d_modular_total_loc
wb.save(filename)


# *********************** footway_S+D_concrete loc yes  *********************************************

footway_s_d_concrete_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Footway') & (df['loc'] == True)
                         & (df['material'] == 'Concrete') & (df['type'] == 'Access & Distribution') ]

footway_s_d_concrete_2x96_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Footway') & (df['loc'] == True)
                         & (df['material'] == 'Concrete') & (df['type'] == 'Access & Distribution')
                         & (df['96mm'] == '2x96')]

num_of_rows_fw_s_d_concrete_loc = footway_s_d_concrete_loc['length'].sum()

num_of_rows_fw_s_d_concrete_2x96_loc = footway_s_d_concrete_2x96_loc['length'].sum()

num_of_rows_fw_s_d_concrete_total_loc = num_of_rows_fw_s_d_concrete_loc + num_of_rows_fw_s_d_concrete_2x96_loc
...
ws = wb[sheets[n]]
ws_tables = []
ws["G53"] = num_of_rows_fw_s_d_concrete_total_loc
wb.save(filename)

# *********************** footway_S+D_unmade and grassverge loc yes  *********************************************

footway_s_d_grassverge_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Footway') & (df['loc'] == True)
                         & (df['material'] == 'Grass Verge') & (df['type'] == 'Access & Distribution')]

footway_s_d_unmade_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Footway') & (df['loc'] == True)
                         & (df['material'] == 'Unmade') & (df['type'] == 'Access & Distribution')]

footway_s_d_grassverge_2x96_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Footway') & (df['loc'] == True)
                         & (df['material'] == 'Grass Verge') & (df['type'] == 'Access & Distribution') & (df['96mm'] == '2x96')]

footway_s_d_unmade_2x96_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Footway') & (df['loc'] == True)
                         & (df['material'] == 'Unmade') & (df['type'] == 'Access & Distribution') & (df['96mm'] == '2x96')]


num_of_rows_fw_s_d_grassverge_loc = footway_s_d_grassverge_loc['length'].sum()

num_of_rows_fw_s_d_unmade_loc = footway_s_d_unmade_loc['length'].sum()

num_of_rows_fw_s_d_grassverge_2x96_loc = footway_s_d_grassverge_2x96_loc['length'].sum()

num_of_rows_fw_s_d_unmade_2x96_loc = footway_s_d_unmade_2x96_loc['length'].sum()

num_of_rows_fw_s_d_unmade_grassverge_total_loc = num_of_rows_fw_s_d_grassverge_loc + num_of_rows_fw_s_d_unmade_loc + num_of_rows_fw_s_d_grassverge_2x96_loc + num_of_rows_fw_s_d_unmade_2x96_loc
...
# *********************** footway_S+D_tarmac loc yes  *********************************************

footway_s_d_tarmac_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Footway') & (df['loc'] == True)
                         & (df['material'] == 'Tarmac' ) & (df['type'] == 'Access & Distribution') ]

footway_s_d_tarmac_2x96_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Footway') & (df['loc'] == True)
                         & (df['material'] == 'Tarmac') & (df['type'] == 'Access & Distribution')
                         & (df['96mm'] == '2x96')]

num_of_rows_fw_s_d_tarmac_loc = footway_s_d_tarmac_loc['length'].sum()

num_of_rows_fw_s_d_tarmac_2x96_loc = footway_s_d_tarmac_2x96_loc['length'].sum()

num_of_rows_fw_s_d_tarmac_total_loc = num_of_rows_fw_s_d_tarmac_loc + num_of_rows_fw_s_d_tarmac_2x96_loc
...
ws = wb[sheets[n]]
ws_tables = []
ws["I53"] = num_of_rows_fw_s_d_tarmac_total_loc
wb.save(filename)

# *********************** footway_S_modular loc yes  *********************************************

footway_s_modular_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Footway') & (df['loc'] == True)
                         & (df['material'] == 'Modular' ) & (df['type'] == 'Access') ]

footway_s_modular_2x96_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Footway') & (df['loc'] == True)
                         & (df['material'] == 'Modular') & (df['type'] == 'Access')
                         & (df['96mm'] == '2x96')]

num_of_rows_fw_s_modular_loc = footway_s_modular_loc['length'].sum()

num_of_rows_fw_s_modular_2x96_loc = footway_s_modular_2x96_loc['length'].sum()

num_of_rows_fw_s_modular_total_loc = num_of_rows_fw_s_modular_loc + num_of_rows_fw_s_modular_2x96_loc
...
ws = wb[sheets[n]]
ws_tables = []
ws["F54"] = num_of_rows_fw_s_modular_total_loc
wb.save(filename)


# *********************** footway_S_concrete loc yes  *********************************************

footway_s_concrete_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Footway') & (df['loc'] == True)
                         & (df['material'] == 'Concrete') & (df['type'] == 'Access') ]

footway_s_concrete_2x96_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Footway') & (df['loc'] == True)
                         & (df['material'] == 'Concrete') & (df['type'] == 'Access')
                         & (df['96mm'] == '2x96')]

num_of_rows_fw_s_concrete_loc = footway_s_concrete_loc['length'].sum()

num_of_rows_fw_s_concrete_2x96_loc = footway_s_concrete_2x96_loc['length'].sum()

num_of_rows_fw_s_concrete_total_loc = num_of_rows_fw_s_concrete_loc + num_of_rows_fw_s_concrete_2x96_loc
...
ws = wb[sheets[n]]
ws_tables = []
ws["G54"] = num_of_rows_fw_s_concrete_total_loc
wb.save(filename)

# *********************** footway_S_unmade and grassverge loc yes  *********************************************

footway_s_grassverge_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Footway') & (df['loc'] == True)
                         & (df['material'] == 'Grass Verge') & (df['type'] == 'Access')]

footway_s_unmade_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Footway') & (df['loc'] == True)
                         & (df['material'] == 'Unmade') & (df['type'] == 'Access')]

footway_s_grassverge_2x96_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Footway') & (df['loc'] == True)
                         & (df['material'] == 'Grass Verge') & (df['type'] == 'Access') & (df['96mm'] == '2x96')]

footway_s_unmade_2x96_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Footway') & (df['loc'] == True)
                         & (df['material'] == 'Unmade') & (df['type'] == 'Access') & (df['96mm'] == '2x96')]


num_of_rows_fw_s_grassverge_loc = footway_s_grassverge_loc['length'].sum()

num_of_rows_fw_s_unmade_loc = footway_s_unmade_loc['length'].sum()

num_of_rows_fw_s_grassverge_2x96_loc = footway_s_grassverge_2x96_loc['length'].sum()

num_of_rows_fw_s_unmade_2x96_loc = footway_s_unmade_2x96_loc['length'].sum()

num_of_rows_fw_s_unmade_grassverge_total_loc = num_of_rows_fw_s_grassverge_loc + num_of_rows_fw_s_unmade_loc + num_of_rows_fw_s_grassverge_2x96_loc + num_of_rows_fw_s_unmade_2x96_loc
...
ws = wb[sheets[n]]
ws_tables = []
ws["H54"] = num_of_rows_fw_s_unmade_grassverge_total_loc
wb.save(filename)

# *********************** footway_S_tarmac loc yes  ************************************************

footway_s_tarmac_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Footway') & (df['loc'] == True)
                         & (df['material'] == 'Tarmac') & (df['type'] == 'Access') ]

footway_s_tarmac_2x96_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Footway') & (df['loc'] == True)
                         & (df['material'] == 'Tarmac') & (df['type'] == 'Access')
                         &  (df['96mm'] == '2x96') ]

num_of_rows_fw_s_tarmac_loc = footway_s_tarmac_loc['length'].sum()

num_of_rows_fw_s_tarmac_2x96_loc = footway_s_tarmac_2x96_loc['length'].sum()

num_of_rows_fw_s_tarmac_total_loc = num_of_rows_fw_s_tarmac_loc + num_of_rows_fw_s_tarmac_2x96_loc
...
ws = wb[sheets[n]]
ws_tables = []
ws["I54"] = num_of_rows_fw_s_tarmac_total_loc
wb.save(filename)

# *********************** footway_T_modular loc yes  *********************************************

footway_t_modular_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Footway') & (df['loc'] == True)
                         & (df['material'] == 'Modular' ) & (df['type'] == 'Trunk') ]

footway_t_modular_2x96_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Footway') & (df['loc'] == True)
                         & (df['material'] == 'Modular') & (df['type'] == 'Trunk')
                         & (df['96mm'] == '2x96')]

num_of_rows_fw_t_modular_loc = footway_t_modular_loc['length'].sum()

num_of_rows_fw_t_modular_2x96_loc = footway_t_modular_2x96_loc['length'].sum()

num_of_rows_fw_t_modular_total_loc = num_of_rows_fw_t_modular_loc + num_of_rows_fw_t_modular_2x96_loc
...
ws = wb[sheets[n]]
ws_tables = []
ws["F55"] = num_of_rows_fw_t_modular_total_loc
wb.save(filename)


# *********************** footway_t_concrete loc yes  *********************************************

footway_t_concrete_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Footway') & (df['loc'] == True)
                         & (df['material'] == 'Concrete') & (df['type'] == 'Trunk') ]

footway_t_concrete_2x96_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Footway') & (df['loc'] == True)
                         & (df['material'] == 'Concrete') & (df['type'] == 'Trunk')
                         & (df['96mm'] == '2x96')]

num_of_rows_fw_t_concrete_loc = footway_t_concrete_loc['length'].sum()

num_of_rows_fw_t_concrete_2x96_loc = footway_t_concrete_2x96_loc['length'].sum()

num_of_rows_fw_t_concrete_total_loc = num_of_rows_fw_t_concrete_loc + num_of_rows_fw_t_concrete_2x96_loc
...
ws = wb[sheets[n]]
ws_tables = []
ws["G55"] = num_of_rows_fw_t_concrete_total_loc
wb.save(filename)

# *********************** footway_T_unmade and grassverge loc yes  *********************************************

footway_t_grassverge_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Footway') & (df['loc'] == True)
                         & (df['material'] == 'Grass Verge') & (df['type'] == 'Trunk')]

footway_t_unmade_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Footway') & (df['loc'] == True)
                         & (df['material'] == 'Unmade') & (df['type'] == 'Trunk')]

footway_t_grassverge_2x96_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Footway') & (df['loc'] == True)
                         & (df['material'] == 'Grass Verge') & (df['type'] == 'Trunk') & (df['96mm'] == '2x96')]

footway_t_unmade_2x96_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Footway') & (df['loc'] == True)
                         & (df['material'] == 'Unmade') & (df['type'] == 'Trunk') & (df['96mm'] == '2x96')]


num_of_rows_fw_t_grassverge_loc = footway_t_grassverge_loc['length'].sum()

num_of_rows_fw_t_unmade_loc = footway_t_unmade_loc['length'].sum()

num_of_rows_fw_t_grassverge_2x96_loc = footway_t_grassverge_2x96_loc['length'].sum()

num_of_rows_fw_t_unmade_2x96_loc = footway_t_unmade_2x96_loc['length'].sum()

num_of_rows_fw_t_unmade_grassverge_total_loc = num_of_rows_fw_t_grassverge_loc + num_of_rows_fw_t_unmade_loc + num_of_rows_fw_t_grassverge_2x96_loc + num_of_rows_fw_t_unmade_2x96_loc
...
ws = wb[sheets[n]]
ws_tables = []
ws["H55"] = num_of_rows_fw_t_unmade_grassverge_total_loc
wb.save(filename)

# *********************** footway_T_tarmac loc yes  ************************************************

footway_t_tarmac_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Footway') & (df['loc'] == True)
                         & (df['material'] == 'Tarmac') & (df['type'] == 'Trunk') ]

footway_t_tarmac_2x96_loc = df.loc[(df['state'] == 'Planned') & (df['surface'] == 'Footway') & (df['loc'] == True)
                         & (df['material'] == 'Tarmac') & (df['type'] == 'Trunk')
                         &  (df['96mm'] == '2x96') ]

num_of_rows_fw_t_tarmac_loc = footway_t_tarmac_loc['length'].sum()

num_of_rows_fw_t_tarmac_2x96_loc = footway_t_tarmac_2x96_loc['length'].sum()

num_of_rows_fw_t_tarmac_total_loc = num_of_rows_fw_t_tarmac_loc + num_of_rows_fw_t_tarmac_2x96_loc
...
ws = wb[sheets[n]]
ws_tables = []
ws["I55"] = num_of_rows_fw_t_tarmac_total_loc
wb.save(filename)
